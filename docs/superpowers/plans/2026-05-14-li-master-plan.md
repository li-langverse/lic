...
**Canonical register:** [docs/verification/provability-gaps.md](../verification/provability-gaps.md) (`G-*` IDs). **Cross-repo map:** [plan-cross-links.md](../ecosystem/plan-cross-links.md) · [live handbook sites](../ecosystem/live-handbook-sites.md).
