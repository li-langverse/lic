# Traceability — PKG-li-std-numerics

<!-- DOC-traceability-PKG-li-std-numerics -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-std-numerics | This repository |
...
| Test | T-PKG-li-std-numerics-smoke | `li-tests/smoke/builds.li` |
