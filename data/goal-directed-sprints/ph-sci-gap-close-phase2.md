...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed** — QM/CFD/FEA tier-2 oracles + dispatch on branch `chore/agent-code_implementer-wp-sci-03-*`.
