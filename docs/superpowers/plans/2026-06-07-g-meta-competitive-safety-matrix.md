...
|-----|-----|-------------|-----------|
| **A** | REQ-GMETA-SCHEMA | **Matrix schema** | Table header approved: languages × {proof-by-default, memory/temporal, interop, agent surfaces, maturity timeline} |
...
**Implemented** on branch `chore/agent-code_implementer-34390187` — see implementation PR for #65.
