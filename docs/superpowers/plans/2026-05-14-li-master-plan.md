...
- [ ] Phase 7d — Execution decorators — **partial (#150 7d-c):** `@vectorized` on `for` → `ArraySimdScope`; **7d-b** lanes=4; **def `@parallel(disjoint=)`** inherits to nested `parallel for` (policy); **open:** MIR elaboration **7d-b–e** ([G-dec plan](2026-06-07-ph-7d-g-dec-mir-elaboration.md) **#22**), full proc tags + Lean **G-par** proofs (**#387**)
