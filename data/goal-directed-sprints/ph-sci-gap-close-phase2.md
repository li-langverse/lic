...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **PARTIAL:** CFD/FEA/QM overlap tier-2 dispatch landed; QM 405–432 + external MD oracle remain.
