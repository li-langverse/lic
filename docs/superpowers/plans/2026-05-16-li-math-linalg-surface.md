...
- [x] Tier 1 perf ≤1.2× C++ (benchmarks dashboard) — green for `#463` six ids on ingest 2026-06-01; local `check-tier1-li-vs-cpp.sh` on `tier-tier1.csv` (2026-06-07): all four pure-Li math microbenches ≤1.2×
