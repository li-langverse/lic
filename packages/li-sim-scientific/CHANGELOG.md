...
- **WP-PLAT-05 MD oracle column** — `md_oracle.toml` registry, `bench-md-oracle-stub.sh` / `ph-sci-md-oracle-gates.sh`, competitive JSON with lammps/gromacs stub rows; smoke `md_oracle_li_checksum.li`.
