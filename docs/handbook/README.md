...
Canonical **language** handbook: [lic-docs Pages](https://docs.lilangverse.xyz/) (source: [`li-langverse/lic-docs`](https://github.com/li-langverse/lic-docs)) — see [docs-site.md](../ecosystem/docs-site.md). **Compiler + verification** hub: [lic Pages](https://li-langverse.github.io/lic/) (static `site/index.html` + plan cross-links nav). This tree under `lic/docs/` mirrors content until submodule wiring completes; edit [lic-docs](https://github.com/li-langverse/lic-docs) for user-facing Pages.
