...
Inner SIMD + outer `parallel for` is the standard Li pattern for hot loops. See [parallel lowering map](parallel-lowering-map.md) for MIR → LLVM / MLIR targets ([#34](https://github.com/li-langverse/lic/issues/34)).
