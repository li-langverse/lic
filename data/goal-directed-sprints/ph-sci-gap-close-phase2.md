...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** CFD ids 205–211 + FEA ids 212–216 tier-2 oracles + `run_algo_registry_cfd_fea_tier2.li`; QM 401–432 remain stub.
