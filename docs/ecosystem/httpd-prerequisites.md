...
| P0-http | HTTP/1.1 parser proofs | `lic` | **Partial** — [`packages/li-http`](../../packages/li-http) (`parse_request`, `match_route` from TOML via `li_rt_httpd.c`, fixture oracle); full header FSM next |
