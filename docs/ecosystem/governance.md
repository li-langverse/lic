...
Li standard and first-party software lives under the **[`li-langverse`](https://github.com/li-langverse)** GitHub organization. This page summarizes rules; the normative plan is [2026-05-16-li-ecosystem-governance.md](../superpowers/plans/2026-05-16-li-ecosystem-governance.md).
...
| Infrastructure libs | `li-langverse/li-net`, `li-http`, … (see [li-httpd plan](../superpowers/plans/2026-05-16-li-httpd-plan.md)) |
...
- **Task-oriented English docs** — see [Documentation style](../contributing/documentation.md)
...
| GitHub org / secrets / new repo | **Action needed from you** — [master plan](../superpowers/plans/2026-05-14-li-master-plan.md) |
