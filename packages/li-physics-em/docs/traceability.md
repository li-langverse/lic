# Traceability — PKG-li-std-physics-em

<!-- DOC-traceability-PKG-li-std-physics-em -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-std-physics-em | This repository |
...
| Test | T-PKG-li-std-physics-em-smoke | `li-tests/smoke/builds.li` |
