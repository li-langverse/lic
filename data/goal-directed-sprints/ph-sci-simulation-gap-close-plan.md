...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **PARTIAL** (QM 401–432 tier-2 landed)
...
- **Progress (2026-06-09):** QM family `run_qm_tier2_registry` + `sim_scientific_oracle_checksum_qm_dft`; smokes `run_algo_registry_qm_tier2.li`. CFD/FEA rows remain heat/stub path — WP-SCI-05/06.
