#!/usr/bin/env bash
        # PH-ML Wave 9 completion gates — LLM recovery + C++/Rust competitors + matmul perf.
        set -euo pipefail
...
')"
        ...
        lic_check_smokes() {
          ...
          for smoke in             packages/li-llm/li-tests/smoke/llm_tokenize_bpe.li             packages/li-llm/li-tests/smoke/llm_safetensors_header.li             packages/li-llm/li-tests/smoke/llm_forward.li             packages/li-llm/li-tests/smoke/llm_generate.li             packages/li-llm/li-tests/smoke/llm_forward_matmul.li             packages/li-ml/li-tests/smoke/ml_matmul_general.li             packages/li-ml-rl/li-tests/smoke/env_pool_process_scaffold.li; do
