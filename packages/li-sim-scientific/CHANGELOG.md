...
- **WP-SCI-03 FEA/CFD tier-2 kernels** — `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_cfd`, `run_fea_tier2_registry` (511–514), `run_cfd_tier2_registry` (521–523); `vertical_fea_linear_elasticity` / `vertical_cfd_lid_driven_cavity` + algo constants in `li-sim`; extended `run_algo_registry_tier2.li`.
