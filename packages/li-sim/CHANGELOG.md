...
- **PH-SIM SIM-2** — `SimReplay`, session `replay_*` on `sim_step`; smoke `sim_replay_stub.li` — [2026-05-26-sim-replay-rl-game-scientific.md](../../docs/release-notes/2026-05-26-sim-replay-rl-game-scientific.md).
