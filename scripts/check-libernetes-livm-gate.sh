...
bash "$ROOT/scripts/check-libernetes-livm-wave2-gate.sh"
bash "$ROOT/scripts/check-libernetes-livm-wave3-gate.sh"
bash "$ROOT/scripts/check-libernetes-livm-wave4-gate.sh"
