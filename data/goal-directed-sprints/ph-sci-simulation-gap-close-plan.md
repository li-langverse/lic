...
- **Landed (Phase 2 slice):** CFD 205–210, FEA 211–216, QM 401–404 tier-2 oracles + dispatch; `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`. Remaining: QM 405–432 SCF, external MD oracle (WP-PLAT-05).
