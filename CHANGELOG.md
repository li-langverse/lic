...
- Compiler: **W0601** / **E0303** — trivial `ensures true` on value-returning `def` (warn by default; error with `--strict-contracts` or `LI_STRICT_CONTRACTS=1`); see `docs/language/contracts-and-proofs.md`.
