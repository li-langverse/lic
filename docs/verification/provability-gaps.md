...
| **G-async** | `@async` / `raises Async` | Structured concurrency proofs | **Partial** — `@async` requires `raises Async`; `await` / `Future[T]` / `then` not parsed; HPX futures rubric in [HPX async futures spec](../superpowers/specs/2026-06-07-li-hpx-async-futures-surface.md) (lic#112) | **2+**, **7d** | `li-tests/effects/` |
