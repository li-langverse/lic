...
- **WP-SCI-03 Phase 2** — tier-2 `run_algo_registry` dispatch for CFD (205–210), FEA (211–216), and QM (401–432); oracles `sim_scientific_oracle_checksum_cfd_lid`, `sim_scientific_oracle_checksum_fea_linear`, `sim_scientific_oracle_checksum_qm_dft`; extended `run_algo_registry_tier2.li`; `li_sim_scientific_version` → 7.
