...
def vc_main_call3_sim_scientific_oracle_checksum_fea_requires_0 : Prop := True
theorem vc_main_call3_sim_scientific_oracle_checksum_fea_requires_0_proved : vc_main_call3_sim_scientific_oracle_checksum_fea_requires_0 := trivial
...
/-! VC call-site requires (opaque): callee 'run_algo' at call 4 -/
def vc_main_call4_run_algo_requires_2 : Prop := True
def vc_main_call5_algo_fea_linear_elasticity_requires_0 : Prop := True
theorem vc_main_call5_algo_fea_linear_elasticity_requires_0_proved : vc_main_call5_algo_fea_linear_elasticity_requires_0 := trivial
...
def vc_main_call7_sim_scientific_oracle_checksum_qm_requires_0 : Prop := True
theorem vc_main_call7_sim_scientific_oracle_checksum_qm_requires_0_proved : vc_main_call7_sim_scientific_oracle_checksum_qm_requires_0 := trivial
...
/-! VC call-site requires (opaque): callee 'run_algo' at call 8 -/
def vc_main_call8_run_algo_requires_2 : Prop := True
def vc_main_call9_algo_qm_dft_scf_energy_requires_0 : Prop := True
theorem vc_main_call9_algo_qm_dft_scf_energy_requires_0_proved : vc_main_call9_algo_qm_dft_scf_energy_requires_0 := trivial
