...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed** on `chore/agent-code_implementer-wp-sci-03-phase2-20260609b` (CFD/FEA/QM tier-2 oracles + dispatch).
