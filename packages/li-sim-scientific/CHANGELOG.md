...
- **WP-SCI-03 CFD/FEA/QM tier-2 kernels** — `sim_scientific_oracle_checksum_cfd` (lid-driven cavity Jacobi), `sim_scientific_oracle_checksum_fea` (2-node bar elasticity), `sim_scientific_oracle_checksum_qm` (`chem_dft_energy_kernel_hartree`); `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); heat tier-2 narrowed to 201–204; smoke `run_algo_registry_tier2.li` extended.
