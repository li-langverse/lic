...
- **WP-SCI-03 Phase 2 tier-2 registry** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; split `run_algo_registry` dispatch for PDE heat (201–204), CFD (205–210), FEA (211–216), QM (401–432); extend `run_algo_registry_tier2.li`.
