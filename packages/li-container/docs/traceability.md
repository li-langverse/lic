# Traceability — PKG-li-container

<!-- DOC-traceability-PKG-li-container -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-container | This repository |
...
| Test | T-PKG-li-container-smoke | `li-tests/smoke/builds.li` |
