...
| **G-meta** | Missing | Compiler ↔ Lean equivalence (research); competitive positioning in [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) — does not close this gap |
...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) | long-term | Not started; [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) documents Li vs Carbon/Mojo/Rust **positioning** only |
