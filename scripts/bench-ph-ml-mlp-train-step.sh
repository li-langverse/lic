...
report = {
    ...
    "autograd_mode": "pilot_backward" if (compile_ok and run_rc == 0) else "forward_only_scaffold",
    "autograd_tape_enabled": compile_ok and run_rc == 0,
    "workload_note": "ml_mlp_train_step_f32 2-2-1; Stage 7 pilot 2x2x2 matmul backward",
    "in_dim": 2,
    "hidden": 2,
    "out_dim": 1,
