# Publish metadata — PKG-li-sim-drug-design

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-sim-drug-design` |
| **Registry name** | `li-sim-drug-design` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-sim-drug-design |
