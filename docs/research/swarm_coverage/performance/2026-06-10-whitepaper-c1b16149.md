...
1. **P0:** Install PyYAML in worker image; re-run ingest/apply to close stale tier-1 reds.
...
- Observer report: `/app/data/runs/swarm_observer-1781081318349.md`
- Orchestrator note: `/workspace/lic/docs/ecosystem/orchestrator-notes/2026-06-10-orch-performance-c1b16149.md`
