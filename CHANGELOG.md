...
- **Proof DB (2f slice):** `proof-db/index.json` + `ProofDB.lean`; `lake build ProofDB` — [2026-05-25-proof-db-lean-bridge.md](docs/release-notes/2026-05-25-proof-db-lean-bridge.md).
