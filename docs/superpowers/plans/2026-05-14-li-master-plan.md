...
| **Doc-c₁** | **Phase exit gates** — phase plans 02 / 03 / 07 cite **G-*** at exit criteria | [phase-02](2026-05-14-phase-02-typechecker.md), [phase-03](2026-05-14-phase-03-mir-codegen.md), [phase-07](2026-05-14-phase-07-native-hpc.md) — `Exit gate — G-* register` tables |
...
See [Doc-c G-* phase exit gates plan](2026-06-07-doc-c-g-star-phase-exit-gates.md) · [PH-Doc-c tracker reconciliation](2026-06-07-ph-doc-c-tracker-reconciliation.md) ([#29](https://github.com/li-langverse/lic/issues/29)).
...
- [x] **Doc-c₁** — phase plan files (02, 03, 07) link **G-*** in exit gates ([#29](https://github.com/li-langverse/lic/issues/29), [#31](https://github.com/li-langverse/lic/issues/31))  
- [x] **Doc-c₂** — spec stubs (`2026-05-16-li-execution-decorators.md`, `2026-05-16-li-math-linalg-surface.md`) use Doc-c **G-*** format  
...
- [x] Phase Doc-c₁ — Phase 02 / 03 / 07 exit gates cite **G-*** register IDs ([#29](https://github.com/li-langverse/lic/issues/29), [#31](https://github.com/li-langverse/lic/issues/31))
- [x] Phase Doc-c₂ — Spec stubs (decorators, math-linalg) use Doc-c **G-*** format
