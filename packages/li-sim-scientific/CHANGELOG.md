...
- **WP-SCI-03 tier-2 kernels (QM/FEA/CFD)** — `sim_scientific_oracle_checksum_qm`, `_fea`, `_cfd`; `run_qm_tier2_registry`, `run_fea_tier2_registry`, `run_cfd_tier2_registry` for algo ids 401–432, 501–523, 601–610; extended `run_algo_registry_tier2.li`.
