# World Studio & Li Engine — RFC stubs

**Status:** Planning stubs (2026-05). Canonical vision: [world-studio-vision.md](../world-studio-vision.md).
...
| [li-array-rfc.md](li-array-rfc.md) | PH-ML |
