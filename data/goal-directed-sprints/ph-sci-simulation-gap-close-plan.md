...
- **Landed (slice):** CFD 205–210 (`sim_scientific_oracle_checksum_cfd`), FEA 211–216 (`_fea`), QM integrals 401–404 (`_qm_overlap`); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`. Remaining registry rows (405–432 QM SCF, 501+, etc.) still stub.
