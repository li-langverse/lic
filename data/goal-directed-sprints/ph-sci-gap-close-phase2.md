...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** QM 401–432 + CFD 521–523 tier-2 dispatch landed; FEA + remaining stub rows open.
