...
- **WP-SCI-03 Phase 2 CFD/FEA/QM tier-2 registry** — `sim_scientific_oracle_checksum_cfd` (SPH poly6 kernel row), `sim_scientific_oracle_checksum_fea` (bar strain energy), `sim_scientific_oracle_checksum_qm` (`chem_dft_energy_kernel_hartree`); `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); `algo_cfd_simple` / `algo_fea_linear_elasticity` in `li-sim`; extended `run_algo_registry_tier2.li` and `scientific_oracle_bench.li`.
