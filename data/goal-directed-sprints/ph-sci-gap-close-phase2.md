...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** tier-2 CFD/FEA/QM oracles + dispatch 206–216, 401–432; stub retained for num/drug/bio/am/viz/robo rows.
