...
| **li-sim-scientific** | partial → tier-2 oracle | CPU + `@gpu` MD oracle smoke | Lib builds with open VC; smokes verify | **Real:** MD/heat/CFD/FEA/QM tier-2 oracles + echem dispatch; `run_multi_physics_at_step`. **Placeholder:** `run_algo_registry_stub` (checksum 1.001) for drug/bio/ml/am/viz/robo/auto/num families | WP-PLAT-05 external MD oracle; remaining non-SCI registry stubs documented |
...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **PARTIAL (CFD/FEA/QM tier-2 on branch)**
...
- **Status (2026-06-08):** `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); heat narrowed to 201–204. Stub retained for drug/bio/ml/am/viz/robo/auto/num.
