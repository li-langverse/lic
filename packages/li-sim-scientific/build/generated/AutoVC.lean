...
def vc_main_call0_li_sim_scientific_version_requires_0 : Prop := True
theorem vc_main_call0_li_sim_scientific_version_requires_0_proved : vc_main_call0_li_sim_scientific_version_requires_0 := trivial
def vc_main_call1_sim_scientific_oracle_checksum_md_requires_0 : Prop := True
theorem vc_main_call1_sim_scientific_oracle_checksum_md_requires_0_proved : vc_main_call1_sim_scientific_oracle_checksum_md_requires_0 := trivial
def vc_main_call2_sim_scientific_oracle_checksum_heat_requires_0 : Prop := True
theorem vc_main_call2_sim_scientific_oracle_checksum_heat_requires_0_proved : vc_main_call2_sim_scientific_oracle_checksum_heat_requires_0 := trivial
def vc_main_call3_run_md_lj_smoke_requires_0 : Prop := True
theorem vc_main_call3_run_md_lj_smoke_requires_0_proved : vc_main_call3_run_md_lj_smoke_requires_0 := trivial
def vc_main_call3_run_md_lj_smoke_requires_1 : Prop := True
theorem vc_main_call3_run_md_lj_smoke_requires_1_proved : vc_main_call3_run_md_lj_smoke_requires_1 := trivial
def vc_main_call4_run_result_ok_requires_0 : Prop := True
theorem vc_main_call4_run_result_ok_requires_0_proved : vc_main_call4_run_result_ok_requires_0 := trivial
def vc_main_call5_run_heat_smoke_requires_0 : Prop := True
theorem vc_main_call5_run_heat_smoke_requires_0_proved : vc_main_call5_run_heat_smoke_requires_0 := trivial
def vc_main_call5_run_heat_smoke_requires_1 : Prop := True
theorem vc_main_call5_run_heat_smoke_requires_1_proved : vc_main_call5_run_heat_smoke_requires_1 := trivial
def vc_main_call6_run_result_ok_requires_0 : Prop := True
theorem vc_main_call6_run_result_ok_requires_0_proved : vc_main_call6_run_result_ok_requires_0 := trivial
...
namespace cfd_oracle_sph_kernel

def vc_cfd_oracle_sph_kernel_requires_0 (r : Float) (h : Float) : Prop := (h > (0 : Float))
def vc_cfd_oracle_sph_kernel_requires_1 (r : Float) (h : Float) : Prop := (r ≥ (0 : Float))
def vc_cfd_oracle_sph_kernel_ensures_0 (r : Float) (h : Float) (result : Float) : Prop := (result ≥ (0 : Float))
def vc_cfd_oracle_sph_kernel_decreases_0 (r : Float) (h : Float) : Nat := 0
theorem vc_cfd_oracle_sph_kernel_decreases_0_proved (r : Float) (h : Float) : vc_cfd_oracle_sph_kernel_decreases_0 r h = 0 := rfl

end cfd_oracle_sph_kernel
...
def vc_sim_scientific_oracle_checksum_cfd_call0_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call0_cfd_oracle_sph_kernel_requires_1 : Prop := ((0 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call1_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call1_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.15 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call2_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call2_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.3 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call3_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call3_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.45 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call4_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call4_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.6 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call5_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call5_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.75 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call6_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call6_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.9 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call7_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call7_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.99 : Float) ≥ (0 : Float))
...
def vc_sim_scientific_oracle_checksum_qm_ensures_0 (result : Float) : Prop := (result > (0 : Float))
...
def vc_sim_scientific_oracle_checksum_qm_call0_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_qm_call0_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.1 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_qm_call1_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_qm_call1_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.2 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_qm_call2_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_qm_call2_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.3 : Float) ≥ (0 : Float))
def vc_sim_scientific_oracle_checksum_qm_call3_cfd_oracle_sph_kernel_requires_0 (h : Float) : Prop := (h > (0 : Float))
def vc_sim_scientific_oracle_checksum_qm_call3_cfd_oracle_sph_kernel_requires_1 : Prop := ((0.4 : Float) ≥ (0 : Float))
...
namespace echem_aimd_batch_steps_valid

def vc_echem_aimd_batch_steps_valid_requires_0 (steps : Int) : Prop := True
theorem vc_echem_aimd_batch_steps_valid_requires_0_proved (steps : Int) : vc_echem_aimd_batch_steps_valid_requires_0 steps := trivial
def vc_echem_aimd_batch_steps_valid_ensures_0 (steps : Int) (result : Int) : Prop := (result ≥ 0)
def vc_echem_aimd_batch_steps_valid_ensures_1 (steps : Int) (result : Int) : Prop := (result ≤ 1)
def vc_echem_aimd_batch_steps_valid_decreases_0 (steps : Int) : Nat := Int.toNat steps
theorem vc_echem_aimd_batch_steps_valid_decreases_0_proved (steps : Int) : vc_echem_aimd_batch_steps_valid_decreases_0 steps = Int.toNat steps := rfl

end echem_aimd_batch_steps_valid

namespace echem_aimd_batch_gpu_path_select

def vc_echem_aimd_batch_gpu_path_select_requires_0 : Prop := True
theorem vc_echem_aimd_batch_gpu_path_select_requires_0_proved : vc_echem_aimd_batch_gpu_path_select_requires_0 := trivial
def vc_echem_aimd_batch_gpu_path_select_ensures_0 (result : Int) : Prop := (result ≥ 0)
def vc_echem_aimd_batch_gpu_path_select_ensures_1 (result : Int) : Prop := (result ≤ 1)
def vc_echem_aimd_batch_gpu_path_select_decreases_0 : Nat := 0
theorem vc_echem_aimd_batch_gpu_path_select_decreases_0_proved : vc_echem_aimd_batch_gpu_path_select_decreases_0 = 0 := rfl

end echem_aimd_batch_gpu_path_select

namespace echem_aimd_batch_run

/-! VC requires (opaque): source expr not yet translated -/
def vc_echem_aimd_batch_run_requires_0 (steps : Int) : Prop := True
theorem vc_echem_aimd_batch_run_requires_0_proved (steps : Int) : vc_echem_aimd_batch_run_requires_0 steps := trivial
/-! VC ensures (opaque): source expr not yet translated -/
def vc_echem_aimd_batch_run_ensures_0 (steps : Int) (result : Int) : Prop := True
theorem vc_echem_aimd_batch_run_ensures_0_proved (steps : Int) (result : Int) : vc_echem_aimd_batch_run_ensures_0 steps result := trivial
/-! VC ensures (opaque): source expr not yet translated -/
def vc_echem_aimd_batch_run_ensures_1 (steps : Int) (result : Int) : Prop := True
theorem vc_echem_aimd_batch_run_ensures_1_proved (steps : Int) (result : Int) : vc_echem_aimd_batch_run_ensures_1 steps result := trivial
/-! VC ensures (opaque): source expr not yet translated -/
def vc_echem_aimd_batch_run_ensures_2 (steps : Int) (result : Int) : Prop := True
theorem vc_echem_aimd_batch_run_ensures_2_proved (steps : Int) (result : Int) : vc_echem_aimd_batch_run_ensures_2 steps result := trivial
/-! VC ensures (opaque): source expr not yet translated -/
def vc_echem_aimd_batch_run_ensures_3 (steps : Int) (result : Int) : Prop := True
theorem vc_echem_aimd_batch_run_ensures_3_proved (steps : Int) (result : Int) : vc_echem_aimd_batch_run_ensures_3 steps result := trivial
def vc_echem_aimd_batch_run_decreases_0 (steps : Int) : Nat := Int.toNat steps
theorem vc_echem_aimd_batch_run_decreases_0_proved (steps : Int) : vc_echem_aimd_batch_run_decreases_0 steps = Int.toNat steps := rfl
def vc_echem_aimd_batch_run_call0_echem_aimd_batch_gpu_path_select_requires_0 (steps : Int) : Prop := True
theorem vc_echem_aimd_batch_run_call0_echem_aimd_batch_gpu_path_select_requires_0_proved (steps : Int) : vc_echem_aimd_batch_run_call0_echem_aimd_batch_gpu_path_select_requires_0 steps := trivial
def vc_echem_aimd_batch_run_call1_echem_aimd_harmonic_k_requires_0 (steps : Int) : Prop := True
theorem vc_echem_aimd_batch_run_call1_echem_aimd_harmonic_k_requires_0_proved (steps : Int) : vc_echem_aimd_batch_run_call1_echem_aimd_harmonic_k_requires_0 steps := trivial
def vc_echem_aimd_batch_run_call2_echem_aimd_total_energy_requires_0 (steps : Int) : Prop := True
theorem vc_echem_aimd_batch_run_call2_echem_aimd_total_energy_requires_0_proved (steps : Int) : vc_echem_aimd_batch_run_call2_echem_aimd_total_energy_requires_0 steps := trivial
def vc_echem_aimd_batch_run_call3_echem_aimd_dft_energy_per_step_requires_0 (steps : Int) : Prop := True
theorem vc_echem_aimd_batch_run_call3_echem_aimd_dft_energy_per_step_requires_0_proved (steps : Int) : vc_echem_aimd_batch_run_call3_echem_aimd_dft_energy_per_step_requires_0 steps := trivial
def vc_echem_aimd_batch_run_call4_echem_aimd_thermostat_step_requires_0 (steps : Int) (target_ke : Float) : Prop := (target_ke ≥ (0 : Float))
def vc_echem_aimd_batch_run_call5_echem_aimd_total_energy_requires_0 (steps : Int) : Prop := True
theorem vc_echem_aimd_batch_run_call5_echem_aimd_total_energy_requires_0_proved (steps : Int) : vc_echem_aimd_batch_run_call5_echem_aimd_total_energy_requires_0 steps := trivial

end echem_aimd_batch_run
...
namespace algo_in_qm_tier2_range

def vc_algo_in_qm_tier2_range_requires_0 (algo_id : Int) : Prop := True
theorem vc_algo_in_qm_tier2_range_requires_0_proved (algo_id : Int) : vc_algo_in_qm_tier2_range_requires_0 algo_id := trivial
def vc_algo_in_qm_tier2_range_ensures_0 (algo_id : Int) (result : Int) : Prop := (result ≥ 0)
def vc_algo_in_qm_tier2_range_ensures_1 (algo_id : Int) (result : Int) : Prop := (result ≤ 1)
def vc_algo_in_qm_tier2_range_decreases_0 (algo_id : Int) : Nat := 0
theorem vc_algo_in_qm_tier2_range_decreases_0_proved (algo_id : Int) : vc_algo_in_qm_tier2_range_decreases_0 algo_id = 0 := rfl

end algo_in_qm_tier2_range
...
def vc_run_algo_registry_call4_run_rigid_smoke_requires_0 (algo_id : Int) (detail : Int) (d2 : Int) : Prop := (d2 ≥ 0)
def vc_run_algo_registry_call4_run_rigid_smoke_requires_1 (algo_id : Int) (detail : Int) (d2 : Int) : Prop := (d2 ≤ 3)
def vc_run_algo_registry_call5_algo_echem_aimd_interface_requires_0 (algo_id : Int) (detail : Int) : Prop := True
theorem vc_run_algo_registry_call5_algo_echem_aimd_interface_requires_0_proved (algo_id : Int) (detail : Int) : vc_run_algo_registry_call5_algo_echem_aimd_interface_requires_0 algo_id detail := trivial
def vc_run_algo_registry_call6_run_echem_aimd_tier2_registry_requires_0 (algo_id : Int) (detail : Int) (d_echem : Int) : Prop := (d_echem ≥ 0)
def vc_run_algo_registry_call6_run_echem_aimd_tier2_registry_requires_1 (algo_id : Int) (detail : Int) (d_echem : Int) : Prop := (d_echem ≤ 3)
/-! VC call-site requires (opaque): callee 'run_echem_aimd_tier2_registry' at call 6 -/
def vc_run_algo_registry_call6_run_echem_aimd_tier2_registry_requires_2 (algo_id : Int) (detail : Int) : Prop := True
def vc_run_algo_registry_call7_algo_echem_gc_aimd_interface_requires_0 (algo_id : Int) (detail : Int) : Prop := True
theorem vc_run_algo_registry_call7_algo_echem_gc_aimd_interface_requires_0_proved (algo_id : Int) (detail : Int) : vc_run_algo_registry_call7_algo_echem_gc_aimd_interface_requires_0 algo_id detail := trivial
def vc_run_algo_registry_call8_run_echem_gc_aimd_tier2_registry_requires_0 (algo_id : Int) (detail : Int) (d_gc : Int) : Prop := (d_gc ≥ 0)
def vc_run_algo_registry_call8_run_echem_gc_aimd_tier2_registry_requires_1 (algo_id : Int) (detail : Int) (d_gc : Int) : Prop := (d_gc ≤ 3)
/-! VC call-site requires (opaque): callee 'run_echem_gc_aimd_tier2_registry' at call 8 -/
def vc_run_algo_registry_call8_run_echem_gc_aimd_tier2_registry_requires_2 (algo_id : Int) (detail : Int) : Prop := True
def vc_run_algo_registry_call9_algo_echem_sei_kmc_requires_0 (algo_id : Int) (detail : Int) : Prop := True
theorem vc_run_algo_registry_call9_algo_echem_sei_kmc_requires_0_proved (algo_id : Int) (detail : Int) : vc_run_algo_registry_call9_algo_echem_sei_kmc_requires_0 algo_id detail := trivial
def vc_run_algo_registry_call10_run_echem_sei_kmc_tier2_registry_requires_0 (algo_id : Int) (detail : Int) (d_sei : Int) : Prop := (d_sei ≥ 0)
def vc_run_algo_registry_call10_run_echem_sei_kmc_tier2_registry_requires_1 (algo_id : Int) (detail : Int) (d_sei : Int) : Prop := (d_sei ≤ 3)
/-! VC call-site requires (opaque): callee 'run_echem_sei_kmc_tier2_registry' at call 10 -/
def vc_run_algo_registry_call10_run_echem_sei_kmc_tier2_registry_requires_2 (algo_id : Int) (detail : Int) : Prop := True
def vc_run_algo_registry_call11_algo_in_qm_tier2_range_requires_0 (algo_id : Int) (detail : Int) : Prop := True
theorem vc_run_algo_registry_call11_algo_in_qm_tier2_range_requires_0_proved (algo_id : Int) (detail : Int) : vc_run_algo_registry_call11_algo_in_qm_tier2_range_requires_0 algo_id detail := trivial
def vc_run_algo_registry_call12_run_qm_tier2_registry_requires_0 (algo_id : Int) (detail : Int) (d_qm : Int) : Prop := (d_qm ≥ 0)
def vc_run_algo_registry_call12_run_qm_tier2_registry_requires_1 (algo_id : Int) (detail : Int) (d_qm : Int) : Prop := (d_qm ≤ 3)
def vc_run_algo_registry_call12_run_qm_tier2_registry_requires_2 (algo_id : Int) (detail : Int) : Prop := (algo_id ≥ 401)
def vc_run_algo_registry_call12_run_qm_tier2_registry_requires_3 (algo_id : Int) (detail : Int) : Prop := (algo_id ≤ 432)
def vc_run_algo_registry_call13_run_algo_registry_stub_requires_0 (algo_id : Int) (detail : Int) (d3 : Int) : Prop := (d3 ≥ 0)
def vc_run_algo_registry_call13_run_algo_registry_stub_requires_1 (algo_id : Int) (detail : Int) (d3 : Int) : Prop := (d3 ≤ 3)
/-! VC call-site requires (opaque): callee 'run_algo_registry_stub' at call 13 -/
def vc_run_algo_registry_call13_run_algo_registry_stub_requires_2 (algo_id : Int) (detail : Int) : Prop := True
...
def vc_run_algo_call14_algo_in_qm_tier2_range_requires_0 (algo_id : Int) (detail : Int) : Prop := True
theorem vc_run_algo_call14_algo_in_qm_tier2_range_requires_0_proved (algo_id : Int) (detail : Int) : vc_run_algo_call14_algo_in_qm_tier2_range_requires_0 algo_id detail := trivial
def vc_run_algo_call15_run_qm_tier2_registry_requires_0 (algo_id : Int) (detail : Int) (d_qm : Int) : Prop := (d_qm ≥ 0)
def vc_run_algo_call15_run_qm_tier2_registry_requires_1 (algo_id : Int) (detail : Int) (d_qm : Int) : Prop := (d_qm ≤ 3)
def vc_run_algo_call15_run_qm_tier2_registry_requires_2 (algo_id : Int) (detail : Int) (reg_run : Int) : Prop := (reg_run ≥ 401)
def vc_run_algo_call15_run_qm_tier2_registry_requires_3 (algo_id : Int) (detail : Int) (reg_run : Int) : Prop := (reg_run ≤ 432)
def vc_run_algo_call16_algo_in_registry_requires_0 (algo_id : Int) (detail : Int) : Prop := True
theorem vc_run_algo_call16_algo_in_registry_requires_0_proved (algo_id : Int) (detail : Int) : vc_run_algo_call16_algo_in_registry_requires_0 algo_id detail := trivial
def vc_run_algo_call17_run_algo_registry_requires_0 (algo_id : Int) (detail : Int) (d4 : Int) : Prop := (d4 ≥ 0)
def vc_run_algo_call17_run_algo_registry_requires_1 (algo_id : Int) (detail : Int) (d4 : Int) : Prop := (d4 ≤ 3)
/-! VC call-site requires (opaque): callee 'run_algo_registry' at call 17 -/
def vc_run_algo_call17_run_algo_registry_requires_2 (algo_id : Int) (detail : Int) (reg_run : Int) : Prop := True
