...
- **WP-SCI-03 Phase 2 CFD/FEA tier-2** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_cfd_tier2_registry`, `run_fea_tier2_registry`; registry dispatch for algo ids 205–210 (CFD) and 211–216 (FEA); heat dispatch narrowed to 201–204; smoke `run_algo_registry_tier2.li` extended.
