...
- **WP-SCI-03 Phase 2 tier-2 QM/CFD/FEA** — `sim_scientific_oracle_checksum_qm`, `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`; `run_qm_tier2_registry` (401–432), `run_cfd_fea_tier2_registry` (205–216); heat dispatch narrowed to 201–204; stub retained for drug/bio/ml/viz/robo/auto (501–903).
