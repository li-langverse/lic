# Traceability — PKG-li-sim-drug-design

<!-- DOC-traceability-PKG-li-sim-drug-design -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-sim-drug-design | This repository |
...
| Test | T-PKG-li-sim-drug-design-smoke | `li-tests/smoke/builds.li` |
