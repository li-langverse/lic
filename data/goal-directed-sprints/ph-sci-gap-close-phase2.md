...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. *(partial — QM/CFD/FEA tier-2 oracles + registry dispatch landed; MD external oracle awaits WP-PLAT-05)*
