...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial:** CFD/FEA/QM tier-2 oracles landed; stub only for non-dispatched registry IDs.
