...
- **WP-SCI-03 Phase 2 slice** — CFD (`205–210`), FEA (`211–216`), QM (`401–432` except documented stub `418`) tier-2 oracles (`sim_scientific_oracle_checksum_cfd/fea/qm`); `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry`; `algo_registry_documented_stub` marks `algo_qm_dft_scf_energy()` only.
