...
- **Acceptance:** `run_algo_registry_tier2.li` extended; stub only for explicitly documented IDs. **Partial (2026-06-07):** QM ids 401–432 use `run_qm_tier2_registry` + `sim_scientific_oracle_checksum_qm`; CFD/FEA still stub.
