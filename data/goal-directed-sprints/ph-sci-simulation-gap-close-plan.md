...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **partial** (CFD/FEA/QM tier-2 dispatch landed; stub remains for gaming/automotive rows)
...
- **Landed (2026-06-09):** algo rows 205–210 (CFD), 211–216 (FEA), 401–432 (QM) dispatch via tier-2 oracles; heat narrowed to 201–204.
