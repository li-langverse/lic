...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **partial (phase 2 slice)**
...
- **Acceptance:** `run_algo_registry_tier2.li` + `scientific_oracle_cfd_fea_qm.li` extended; stub only for explicitly documented IDs.
- **Landed (2026-06-08):** QM (`401–432`), CFD (`205–210`), FEA (`211–216`) tier-2 oracles + registry dispatch; heat narrowed to `201–204`.
- **Remaining:** external MD oracle column (WP-PLAT-05); full cavity/FEA kernels (WP-SCI-05/06).
