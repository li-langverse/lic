...
1. **WP-SCI-03** — ~~`run_algo_registry` real kernels (CFD/FEA/QM rows)~~ **partial landed** — tier-2 dispatch for algo ids 401–432 / 501–523 / 601–610; `run_algo_registry_tier2.li` extended; stub retained for 701+.
