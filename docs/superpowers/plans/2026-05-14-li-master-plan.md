...
- [ ] Phase 2j — Full OOP — **in progress:** **2j-a/b/c done** (PR #134): methods, `private def`, MIR in-out write-back; **next 2j-d** inheritance — [OOP roadmap](2026-05-20-li-oop-roadmap.md)
