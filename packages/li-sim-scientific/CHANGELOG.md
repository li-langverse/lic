...
- **WP-SCI-03 tier-2 CFD/FEA/QM oracles** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; `run_cfd_tier2_registry` (205–211), `run_fea_tier2_registry` (212–216), `run_qm_tier2_registry` (401–432) dispatch; heat tier-2 narrowed to 201–204; smoke `run_algo_registry_tier2.li` extended.
