...
**Status:** Phase 0–3 complete on `cursor/ph-ml-stage2-dl-spine` (2026-06-04); run `code_implementer-1780568652709` rebases onto `main` (post #823), re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; PR #816 mergeable); run `code_implementer-1780560489897` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780560288294` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780560076918` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780559875509` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780559664223` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780559458462` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780559235684` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780559011075` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, stdlib_coverage 4/4, science_gpu 20/20, Phase 0–3 exit 0; std_gap PH-IO-4 closed on branch); run `code_implementer-1780558796693` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, science_gpu 20/20, Phase 0–3 exit 0); run `code_implementer-1780558568972` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`; stdlib_seal 9/9, science_gpu 20/20, Phase 0–3 exit 0); run `code_implementer-1780558349175` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (stdlib_seal 9/9, science_gpu 20/20); prior `code_implementer-1780558137931` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (stdlib_seal 9/9, science_gpu 20/20); prior `code_implementer-1780557917735` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (stdlib_seal 9/9, science_gpu 20/20); prior `code_implementer-1780557702776` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (stdlib_seal 9/9, science_gpu 20/20); prior `code_implementer-1780557499815` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (stdlib_seal 9/9, science_gpu 20/20); prior `code_implementer-1780557283167` re-verifies `ph-sci-all-gates.sh` + `check-ph-io-4-gate.sh` (`LIC=build/compiler/lic/lic` after `./scripts/build.sh`): std_gap **PH-IO-4 closed** (`std/io/io.li`, `std/csv/csv.li`, smoke `ph_io4_ingest_contract.li` + `scientific_csv_ingest_gate.li`, `stdlib_seal` 9/9); prior `code_implementer-1780556723760` fixes smoke tier + monorepo smoke registration; **PH-IO-4** std.io/csv contract in `std/io`, `std/csv`, `ph_io4`, and phase0 gate. WP-SCI-GPU-VENDOR-02 MD grid device-buffer readback parity; **PH-IO-4** std.io/csv ingest contract (`file_read_then_close`, `csv_field_count_stub`, `scripts/check-ph-io-4-gate.sh`) (`scientific_gpu_md_device_buffer.li`, `bench-ph-sci-md-device-buffer.sh`, 0.1% force-checksum tolerance); prior: WP-SCI-GPU-VENDOR-01 MD oracle LKIR launch; WP-SCI-03 registry tier-2; WP-SCI-GPU-03 `nbody_pair_force`. Gates: `scripts/ph-sci-phase{0,1,2,3}-gates.sh`, `scripts/ph-sci-gpu-gates.sh` (exports `LIC` before `science_gpu`).  
...
## GPU Chem / DFT + Electrochemistry (headline — merged from main)

See **[ph-sci-gpu-chem-dft.md](ph-sci-gpu-chem-dft.md)** for WP-SCI-GPU-CHEM-01..04, stub vs real audit, and PH-ML Phase 3 LKIR hooks. Electrochemistry WP-ECHEM-01..08 (CHE/SHE/EDL/NEB, potential-dependent SCF) and PH-SCI-GPU-16..19 gates — see [ph-sci-electrochemistry-sim-plan.md](ph-sci-electrochemistry-sim-plan.md).
