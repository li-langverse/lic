...
- **WP-SCI-03 FEA/CFD tier-2 oracles** — `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_cfd`, `run_fea_tier2_registry` (211–216), `run_cfd_tier2_registry` (205–210); heat dispatch narrowed to 201–204; `vertical_fea_linear_elasticity` / `vertical_cfd_lid_driven_cavity`; smoke `run_algo_registry_tier2.li` extended for algo 206/215.
