...
- **WP-SCI-03 CFD/FEA/QM tier-2 registry** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm_dft`; split `run_algo_registry` dispatch for PDE heat (201–204), CFD (205–210), FEA (211–216), QM (401–432); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity`; smokes `run_algo_registry_tier2_{qm,cfd,fea}.li`; base tier2 heat row uses algo 201.
