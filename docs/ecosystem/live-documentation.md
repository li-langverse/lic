...
| **Package handbooks** | [Ecosystem → Package handbooks](overview.md#package-handbooks-live-site) | [`lic`](https://github.com/li-langverse/lic) `docs/ecosystem/` | lip, lit, lis, li-net, li-httpd, li-std-*, li-demo — deploy via **li-language** Pages |
