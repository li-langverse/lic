...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for undocumented IDs only (CFD 205–210, FEA 211–216, QM 401–432 now tier-2 oracles); `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
