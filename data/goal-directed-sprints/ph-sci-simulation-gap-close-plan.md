...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **PARTIAL** (CFD/FEA/QM tier-2 on branch `chore/agent-code_implementer-wp-sci-03-phase2-1781032990`)
...
- **Status:** CFD (205–210), FEA (211–216), QM (401–432) tier-2 oracles + dispatch landed; heat narrowed to 201–204; MD external oracle column still open (WP-PLAT-05).
