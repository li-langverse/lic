...
- **Landed (2026-06-08):** PDE heat (201–204), CFD (205–210), FEA (211–216), QM (401–432) tier-2 dispatch in `li-sim-scientific`; smokes `run_algo_registry_tier2_{qm,cfd,fea}.li`; `benchmarks/competitive/algo_registry.json` regenerated. Stub remains for non-science families (drug/bio/ml/…).
