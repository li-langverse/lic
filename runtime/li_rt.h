...
int32_t httpd_pure_li_tls_i(void);
...
int32_t httpd_pure_tls_slot_active_i(int32_t slot);
int32_t httpd_pure_tls_attach_i(int32_t slot, int32_t conn);
int32_t httpd_pure_tls_poll_i(int32_t slot);
int32_t httpd_pure_tls_read_app_i(int32_t slot, int max_bytes);
int32_t httpd_pure_tls_write_app_i(int32_t slot, int len);
int32_t httpd_pure_tls_alpn_i(int32_t slot);
