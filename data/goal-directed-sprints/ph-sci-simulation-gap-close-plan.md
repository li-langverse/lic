...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for QM rows (401–432); `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
...
- **Status:** partial (2026-06-08) — CFD (205–210) + FEA (211–216) tier-2 oracles; QM (401–432) remains documented stub.
