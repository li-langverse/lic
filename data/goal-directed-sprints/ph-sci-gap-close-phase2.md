...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **QM slice landed 2026-06-08** (ids 401–432 → `run_qm_tier2_registry`); CFD/FEA + drug/AM/auto rows still stub.
