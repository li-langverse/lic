...
| BUG-C-02 | `bounds_guard_codegen_gap.sh` | [BUG-C-02.md](BUG-C-02.md) | Open | OPEN |
| BUG-C-03 | `broadcast_len1_codegen_lean_gap.sh` | [BUG-C-03.md](BUG-C-03.md) | Open (Lean spec) | PASS |
| BUG-C-04 | `horner_fma_numerically_stable_gap.sh` | [BUG-C-04.md](BUG-C-04.md) | Open | OPEN |
| BUG-C-05 | `mat2_at2_mir_codegen_lean_gap.sh` | [BUG-C-05.md](BUG-C-05.md) | Open | OPEN |
| BUG-C-06 | `matmul_loop_codegen_witness_gap.sh` | [BUG-C-06.md](BUG-C-06.md) | Open | OPEN |
| BUG-C-07 | `method_call_requires_lean_gap.sh` | [BUG-C-07.md](BUG-C-07.md) | Open (witness-only) | PASS |
| BUG-C-08 | `parallel_disjoint_lean_opaque_gap.sh` | [BUG-C-08.md](BUG-C-08.md) | Open | OPEN |
