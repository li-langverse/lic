# Orchestrator note — performance gap orchestration (`7a1258c9`)
...
5. **Studio-ui:** mount `lic-studio-ui` or set `STUDIO_UI_ROOT` for gap apply.
...
| `ci_maintainer` | 34 repos missing CI on main | platform |
...
- `/app/data/runs/swarm_observer-1781177787189.md`
