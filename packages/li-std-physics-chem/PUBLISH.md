# Publish metadata — PKG-li-std-physics-chem

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-std-physics-chem` |
| **Registry name** | `li-std-physics-chem` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-std-physics-chem |
