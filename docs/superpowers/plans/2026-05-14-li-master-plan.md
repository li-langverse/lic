...
- [ ] Phase 2i — Math / linalg surface — **partial:** **2i-a/c** (#148); **2i-b** `norm`, `sum`/`dot`, `reductions/`, same-length `**`, prelude `axpy`, scalar×array; **length-1 broadcast compile_ok** (`broadcast_len1_*.li`, [2026-05-22-2i-broadcast-len1.md](../../release-notes/2026-05-22-2i-broadcast-len1.md)); Lean witness ([#574](https://github.com/li-langverse/lic/issues/574)) + full NumPy rank broadcast ([#526](https://github.com/li-langverse/lic/issues/526)) still open; float `@` Props closed (`mat2_at2_eval`)
