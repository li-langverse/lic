...
- **WP-SCI-03 CFD/FEA tier-2 registry dispatch** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216); heat dispatch narrowed to 201–204; `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`; QM 401–432 remain documented stub (checksum 1.001).
