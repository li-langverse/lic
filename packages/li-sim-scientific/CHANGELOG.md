...
- **WP-SCI-03 QM tier-2 registry** — `sim_scientific_oracle_checksum_qm`, `run_qm_tier2_registry` dispatch for algo ids 401–432 via `chem_dft_energy_kernel_hartree`; `run_algo_registry_tier2.li` asserts 418/401 ≠ stub checksum 1.001.
