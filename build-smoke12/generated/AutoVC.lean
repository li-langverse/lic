...
def vc_main_call1_run_result_ok_requires_0 : Prop := True
theorem vc_main_call1_run_result_ok_requires_0_proved : vc_main_call1_run_result_ok_requires_0 := trivial
def vc_main_call2_run_algo_requires_0 : Prop := True
theorem vc_main_call2_run_algo_requires_0_proved : vc_main_call2_run_algo_requires_0 := trivial
def vc_main_call2_run_algo_requires_1 : Prop := True
theorem vc_main_call2_run_algo_requires_1_proved : vc_main_call2_run_algo_requires_1 := trivial
def vc_main_call2_run_algo_requires_2 : Prop := True
theorem vc_main_call2_run_algo_requires_2_proved : vc_main_call2_run_algo_requires_2 := trivial
