...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) — positioning in [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) | long-term | Not started |
