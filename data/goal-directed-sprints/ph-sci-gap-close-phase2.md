...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** FEA 217 + CFD 218 tier-2 landed; QM 401–432 still stub.
