...
**Last updated:** 2026-06-07 · **main @** `e87165b7` (Phase 0/1 + echem merged; start from latest `main`)  
...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-07):** CFD 205–210, FEA 211–216, QM 401–432 tier-2 oracles landed; stub 1.001 only for non-dispatched registry ids.
