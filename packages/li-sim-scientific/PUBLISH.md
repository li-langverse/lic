# Publish metadata — PKG-li-sim-scientific

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-sim-scientific` |
| **Registry name** | `li-sim-scientific` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-sim-scientific |
