...
- **sim-p2-qm-dft-scf (algo_id=418)** — `sim_scientific_oracle_checksum_qm_dft_scf`, `run_qm_dft_scf_tier2_registry`, H₂ STO-3G DFT-SCF energy oracle via `echem_dft_h2_energy_hartree`; smoke `qm_dft_scf_interface_smoke.li`; replaces registry stub checksum 1.001 for `qm_dft_scf_energy`.
