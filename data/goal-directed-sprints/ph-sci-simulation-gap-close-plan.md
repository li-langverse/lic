...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for drug/bio/am/viz/robo/auto families (CFD/FEA/QM tier-2 landed WP-SCI-03 Phase 2); `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
