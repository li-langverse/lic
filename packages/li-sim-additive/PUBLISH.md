# Publish metadata — PKG-li-sim-additive

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-sim-additive` |
| **Registry name** | `li-sim-additive` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-sim-additive |
