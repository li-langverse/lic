# Publish metadata — PKG-li-physics-custom

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-physics-custom` |
| **Registry name** | `li-physics-custom` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-physics-custom |
