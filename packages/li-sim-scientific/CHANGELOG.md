...
- **WP-SCI-03 CFD/FEA tier-2 kernels** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_cfd_tier2_registry` / `run_fea_tier2_registry` for algo ids 205–210 / 211–216; heat dispatch narrowed to 201–204; `run_algo_registry_tier2.li` extended; `li_sim_scientific_version` → 7.
