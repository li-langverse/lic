...
- **WP-SCI-03 CFD/FEA/QM tier-2 registry** — `sim_scientific_oracle_checksum_cfd` (lid-driven cavity slice), `sim_scientific_oracle_checksum_fea` (1D bar Jacobi solve), `sim_scientific_oracle_checksum_qm` (`chem_dft_gpu_energy_checksum`); `run_cfd_tier2_registry` / `run_fea_tier2_registry` / `run_qm_tier2_registry` for algo ids 205–210, 211–216, 401–432; extended `run_algo_registry_tier2.li` and `scientific_oracle_bench.li`.
