...
- **WP-SCI-03 Phase 2 — CFD/FEA/QM tier-2 registry dispatch** — `sim_scientific_oracle_checksum_cfd` (SPH + euler advect), `sim_scientific_oracle_checksum_fea` (PBD chain relax), `sim_scientific_oracle_checksum_qm` (`norm_sq_1d` state norm); split PDE family 201–205 heat / 206–211 CFD / 212–216 FEA; QM 401–432 real dispatch; `vertical_cfd_cavity` / `vertical_fea_elasticity`; smokes extended.
