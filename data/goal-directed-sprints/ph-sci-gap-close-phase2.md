...
**Last updated:** 2026-06-09 · **main @** latest (Phase 0/1 + echem merged)  
...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. — **partial landed** (CFD 205–210, FEA 211–216, QM 401–432 tier-2 oracles; MD external oracle still WP-PLAT-05)
