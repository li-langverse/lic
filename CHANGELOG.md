...
- **2i-b / 7e / 2f slice:** prelude `axpy`, array `**`, reductions; `linalg_dot4_float_closed`; `lic build --strict-lean`; IKJ `ArrayMatMul2DF64`; `check-tier1-li-vs-cpp.sh`; see `docs/release-notes/2026-05-21-2i-7e-2f-math-surface.md`.
