...
- **Landed (2026-06-07):** QM ids 401–432 → `sim_scientific_oracle_checksum_qm` / `run_qm_tier2_registry` (`chem_dft_energy_kernel_hartree`). **Remaining:** FEA/CFD registry rows (WP-SCI-05/06); drug/robo/am/auto families 501+ still stub.
