...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **partial** (FEA/CFD tier-2 2026-06-07)
...
- **Landed slice:** FEA (511–514) + CFD (521–523) tier-2 dispatch; QM rows remain stub (1.001).
