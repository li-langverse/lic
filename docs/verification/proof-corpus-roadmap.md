...
| Suite | Result | Notes |
|-------|--------|-------|
| `run_all.sh contracts_verify` | **26 pass / 0 fail** (14 `prove_lean_ok` + 12 `verify_ok`/`verify_open_ok`) | **P-float** `sqrt_open_bound` closed; `prove_lean_ok` runs lake when elan on PATH |
