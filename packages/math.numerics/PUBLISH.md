# Publish metadata — PKG-math-numerics

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-math-numerics` |
| **Registry name** | `math.numerics` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/math.numerics |
