# Publish metadata — PKG-li-store-realtime

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-store-realtime` |
| **Registry name** | `li-store-realtime` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-store-realtime |
