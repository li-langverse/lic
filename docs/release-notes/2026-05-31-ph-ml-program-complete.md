...
**Agent verification (2026-06-04):** run `code_implementer-1780582186499` — rebased PR #789 onto main (#826); merged sibling `/workspace/lic` discovery into `lic-bin-select.sh` and `lic-runnable.sh`; wave gates keep `li_ensure_lic` after #802.
