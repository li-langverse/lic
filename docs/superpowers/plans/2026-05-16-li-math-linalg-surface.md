...
- [ ] Tier 1 perf ≤1.2× C++ (benchmarks dashboard) — six red rows tracked in [PH-7e honesty plan](2026-05-30-ph7e-tier1-red-benchmark-honesty.md); do not check until sub-phase F + ingest refresh
