...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-07):** PDE band split — heat 201–204, CFD lid-cavity oracle 205–210, FEA bar oracle 211–216; QM 401–432 still stub (1.001).
