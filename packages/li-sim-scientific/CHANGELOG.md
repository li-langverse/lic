...
- **WP-SCI-03 tier-2 kernels** — `sim_scientific_oracle_checksum_md`, `sim_scientific_oracle_checksum_heat`, `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_algo_registry` MD/heat/CFD/FEA/rigid dispatch; smokes `scientific_oracle_bench.li`, `run_algo_registry_tier2.li`, `run_algo_registry_cfd_fea_tier2.li`.
