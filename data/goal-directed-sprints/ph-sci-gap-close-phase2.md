...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **In progress @** `chore/agent-code_implementer-wp-sci-03-tier2-20260609k` — QM/CFD/FEA tier-2 oracles + registry dispatch (401–432, 501–523, 601–610); stub retained for 701+.
