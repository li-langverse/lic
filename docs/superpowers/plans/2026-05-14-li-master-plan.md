...
**Canonical register:** [docs/verification/provability-gaps.md](../verification/provability-gaps.md) (`G-*` IDs). **Plan map:** [plan-cross-links.md](../../ecosystem/plan-cross-links.md).
