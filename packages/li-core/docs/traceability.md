# Traceability — PKG-li-std-core

<!-- DOC-traceability-PKG-li-std-core -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-std-core | This repository |
...
| Test | T-PKG-li-std-core-smoke | `li-tests/smoke/builds.li` |
