...
| **LAMMPS/GROMACS** | **Stub (B0)** | External oracle column plan shipped — [competitive-engines-plan.md](../benchmarks/competitive-engines-plan.md), `md_oracle.toml`, `check-md-oracle-plan.sh`; csv columns B3 |
...
| Tier-2 external MD oracle | **Stub B0** (`md_oracle.toml` + stub gate; real LAMMPS/GROMACS B1+) |
