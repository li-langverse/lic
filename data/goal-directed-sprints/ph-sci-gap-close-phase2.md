...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li` — **partial (2026-06-09)** — QM 401–432, CFD 205–210, FEA 211–216 tier-2 dispatch; stub retained for robo/am/drug rows.
2. **WP-PLAT-05** — LAMMPS/GROMACS external oracle column (unblocks SCI-03 MD rows) — **stub landed (2026-06-09)**.
