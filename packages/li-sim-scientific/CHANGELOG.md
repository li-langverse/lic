...
- **WP-SCI-03 Phase 2 CFD/FEA tier-2** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216); heat dispatch narrowed to 201–204; `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity`; `run_algo_registry_tier2.li` extended.
