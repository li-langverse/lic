...
After Wave 6: conformance subset, homelab cutover from k3s (Phase 7 in master plan).
...
- `packages/li-libernetes-kubelet/src/sync.li` — apiserver↔kubelet local sync loop stub
- `packages/li-libernetes-apiserver/src/informer_sync.li` — informer wiring stub
