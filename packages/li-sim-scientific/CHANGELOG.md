...
- **WP-SCI-03 Phase 2 CFD/FEA/QM tier-2** — `sim_scientific_oracle_checksum_cavity`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; PDE registry ids 205–216 split (CFD/FEA vs heat) inside `run_heat_tier2_registry`; inline QM dispatch for 401–432; extended `run_algo_registry_tier2.li`.
