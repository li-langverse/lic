...
- **WP-SCI-03 CFD/FEA tier-2 kernels** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216); vertical ids `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity`; extended smoke `run_algo_registry_tier2.li`.
...
- `run_heat_tier2_registry` scoped to heat PDE ids 201–204 (CFD/FEA split to dedicated tier-2 paths); `li_sim_scientific_version` → 7 (WP-SCI-03 CFD/FEA).
