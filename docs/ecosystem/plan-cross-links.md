...
| [parallel-compile-ci](../superpowers/plans/2026-05-22-parallel-compile-ci.md) | **PH-8p** | — |
| [httpd-plan](../superpowers/plans/2026-05-16-li-httpd-plan.md) | **PH-H** | **G-net** |
| [ecosystem-governance](../superpowers/plans/2026-05-16-li-ecosystem-governance.md) | Org policy | — |
| [oop-roadmap](../superpowers/plans/2026-05-20-li-oop-roadmap.md) | **PH-2j** | **G-oop**, **G-def** |
...
Package repos ship minimal GitHub Pages handbooks (`site/index.html` + `.github/workflows/pages.yml`) linking here. **Live today:** [li-language](https://li-langverse.github.io/li-language/), [benchmarks](https://li-langverse.github.io/benchmarks/). **Pending merge/deploy on `main`:** `lip`, `lit`, `lis`, `li-demo`, `li-httpd`, `li-net`, `li-std-core`, `li-std-math`, `roadmap`. Until Pages deploy, use in-repo `docs/handbook.md` in each repo.
