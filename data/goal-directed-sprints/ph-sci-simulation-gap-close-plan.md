...
- **Acceptance:** `run_algo_registry_tier2.li` extended; stub only for explicitly documented IDs (`418` via `algo_registry_documented_stub`).
- **Landed (2026-06-08):** CFD `205–210`, FEA `211–216`, QM `401–432` except `418`; heat narrowed to `201–204`.
