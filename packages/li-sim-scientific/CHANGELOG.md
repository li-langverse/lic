...
- **WP-PLAT-05 MD external oracle stub** — `md_oracle.toml` competitive driver, `run_md_oracle_external_tier2_registry` for algo **104**; `run_algo_registry_tier2.li` row; bench `ph-sci-md-oracle-competitive-gates.sh`.
