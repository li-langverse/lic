...
- **WP-SCI-03 CFD/FEA/QM tier-2 registry** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; split PDE family dispatch (201–204 heat, 205–210 CFD, 211–216 FEA, 401–432 QM); extend `run_algo_registry_tier2.li`.
