...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) — [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) documents positioning only | long-term | Not started |
