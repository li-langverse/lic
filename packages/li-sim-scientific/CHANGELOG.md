...
- **WP-SCI-03 Phase 2 CFD/FEA/QM tier-2** — `sim_scientific_oracle_checksum_cfd`, `_fea`, `_qm`; `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry`; heat dispatch narrowed to algo 201–204; `run_algo_registry_tier2.li` extended.
...
- Package smokes sync `li_sim_scientific_version` witness to 7; AIMD oracle returns positive relative-drift floor when energy is numerically conserved.
