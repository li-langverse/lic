...
- [ ] Phase 7e — Math → SIMD/parallel lowering — **partial (#148, #150, #155, [#424](https://github.com/li-langverse/lic/issues/424)):** loop matmul + FMA horner codegen on `main`; **tier-1 perf honesty:** six dashboard-red rows — see [PH-7e tier-1 honesty plan](2026-05-30-ph7e-tier1-red-benchmark-honesty.md); **`check-tier1-li-vs-cpp.sh`** advisory default (strict optional); **open:** tier-1 ≤1.2× closure per row class, full float Lean Props
