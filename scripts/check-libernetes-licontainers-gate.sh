...
bash "$ROOT/scripts/check-libernetes-licontainers-wave2-gate.sh"
bash "$ROOT/scripts/check-libernetes-licontainers-wave3-gate.sh"
bash "$ROOT/scripts/check-libernetes-licontainers-wave4-gate.sh"
