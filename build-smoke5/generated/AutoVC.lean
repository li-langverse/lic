...
def vc_main_call2_run_heat_smoke_requires_0 : Prop := True
theorem vc_main_call2_run_heat_smoke_requires_0_proved : vc_main_call2_run_heat_smoke_requires_0 := trivial
def vc_main_call2_run_heat_smoke_requires_1 : Prop := True
theorem vc_main_call2_run_heat_smoke_requires_1_proved : vc_main_call2_run_heat_smoke_requires_1 := trivial
def vc_main_call3_run_result_ok_requires_0 : Prop := True
theorem vc_main_call3_run_result_ok_requires_0_proved : vc_main_call3_run_result_ok_requires_0 := trivial
def vc_main_call4_sim_scientific_oracle_checksum_md_requires_0 : Prop := True
theorem vc_main_call4_sim_scientific_oracle_checksum_md_requires_0_proved : vc_main_call4_sim_scientific_oracle_checksum_md_requires_0 := trivial
def vc_main_call5_run_md_lj_smoke_requires_0 : Prop := True
theorem vc_main_call5_run_md_lj_smoke_requires_0_proved : vc_main_call5_run_md_lj_smoke_requires_0 := trivial
def vc_main_call5_run_md_lj_smoke_requires_1 : Prop := True
theorem vc_main_call5_run_md_lj_smoke_requires_1_proved : vc_main_call5_run_md_lj_smoke_requires_1 := trivial
