...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-07):** FEA/CFD/QM tier-2 oracles + split dispatch landed; 418 remains documented stub.
