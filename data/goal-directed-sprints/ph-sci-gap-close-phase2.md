...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **PARTIAL landed 2026-06-08** — QM/CFD/FEA tier-2 oracles + registry dispatch; per-algo depth + WP-PLAT-05 remain.
