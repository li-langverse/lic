...
- **WP-SCI-03 Phase 2 tier-2 kernels** — `sim_scientific_oracle_checksum_qm_dft`, `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`; split PDE registry 201–204 heat / 205–210 CFD / 211–216 FEA; QM 401–432 tier-2 dispatch; `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`; extended `run_algo_registry_tier2.li`.
