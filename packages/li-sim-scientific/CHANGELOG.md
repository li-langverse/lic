...
- **WP-SCI-03 Phase 2 CFD/FEA/QM tier-2** — `sim_scientific_oracle_checksum_qm`, `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea_bar`, `run_qm_tier2_registry`, `run_cfd_tier2_registry`, `run_fea_tier2_registry`; `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity`; extended `run_algo_registry_tier2.li`.
