...
| Local tier-1 (this pass, `li_rt_volatile_sink_f64`) | **11.7×** | Honest pure-Li scalar codegen vs native C reference |
...
Still **red** (~11.7×). Next work is **PH-7e** codegen (SIMD/unroll Horner), not catalog threshold edits. Lexer `Plus` fix is already on `main` ([autoresearch-horner-lexer-2026-05-18.md](./autoresearch-horner-lexer-2026-05-18.md)).
