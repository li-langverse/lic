...
| **G-meta** | Missing | Compiler ↔ Lean equivalence (research) — competitive positioning doc: [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) (does not close gap) |
...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) — see [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) for honest Li vs Carbon/Mojo/Rust positioning | long-term | Not started |
