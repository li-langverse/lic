...
- **`site/index.html` required** — without it the Pages workflow fails (fixed in [2026-05-30-lic-pages-site-artifact.md](../release-notes/2026-05-30-lic-pages-site-artifact.md))
