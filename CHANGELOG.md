...
- Call-site callee **`requires`** obligations in `build/generated/AutoVC.lean` (Phase **2e**); literal-arg static discharge (Phase **2f**); `li-tests/contracts_verify/caller_requires_ok.li`.
