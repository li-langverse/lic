...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-07):** CFD ids 205–210 + FEA ids 211–216 tier-2 dispatch landed; QM rows remain stub (1.001).
