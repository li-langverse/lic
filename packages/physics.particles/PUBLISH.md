# Publish metadata — PKG-physics-particles

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-physics-particles` |
| **Registry name** | `physics.particles` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/physics.particles |
