...
- **Smoke:** `packages/li-array/li-tests/smoke/array_matmul_32.li` (LKIR logical 32×32 path)
- **Metric:** `ratio_vs_li = numpy_cpu_sec / li_cpu_sec` (run-only; target ≤2.0 is aspirational until BLAS hook lands)
- **Competitive row:** `li_array_matmul_4x4` in `ph-ml-competitive.json` (4×4 pilot); 32×32 tracked separately
