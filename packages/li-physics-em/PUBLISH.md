# Publish metadata — PKG-li-physics-em

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-physics-em` |
| **Registry name** | `li-physics-em` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-physics-em |
