...
| `sqrt_open_bound.li` | `abs(result² - x) < ε` with `li_rt_sqrt` body | **Closed** — `prove_lean_ok` via `Li.Discharge.sqrt_open_bound_spec` (trusted libm) |
| `refinement_call_ok.li` | Literal call-site NonNeg | **Closed** — `prove_lean_ok` |
