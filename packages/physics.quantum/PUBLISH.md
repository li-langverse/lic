# Publish metadata — PKG-physics-quantum

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-physics-quantum` |
| **Registry name** | `physics.quantum` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/physics.quantum |
