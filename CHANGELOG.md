...
- **PH-2i-b broadcast reject gate:** document NumPy rank broadcast defer criteria; rank-2 `compile_fail` seeds; master-plan + **G-math** tracker — [2026-06-06-ph-2i-broadcast-reject-gate.md](docs/release-notes/2026-06-06-ph-2i-broadcast-reject-gate.md) ([#526](https://github.com/li-langverse/lic/issues/526)).
...
- **Docs:** GUI UX quality handoff for `gui_ux_tester` + **Doc-c** proof-gap links on open phase plans — [2026-05-30-gui-ux-handoff-plan-cross-links.md](docs/release-notes/2026-05-30-gui-ux-handoff-plan-cross-links.md); handbook + Pages hub nav link; studio-ux-12 harness **Partial** note.
...
- **`import lig.present` gap (PR #251):** flatten present into `packages/li-gpu/src/lib.li` — [2026-05-25-gap-lig-present-import.md](docs/release-notes/2026-05-25-gap-lig-present-import.md).
- **PH-UX vertical gap #1:** Studio UI bench registry and `bench-studio-viewport-perf.sh` reference `packages/li-gpu` (`wgpu_smoke` hook) instead of removed `packages/li-gpu` — [2026-05-25-vertical-gap-bench-lig.md](docs/release-notes/2026-05-25-vertical-gap-bench-lig.md).
