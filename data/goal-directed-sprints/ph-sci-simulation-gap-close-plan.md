...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for algo 418 + non-science families; `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak. **WP-SCI-03 partial:** CFD/FEA/QM registry rows now tier-2 oracles.
