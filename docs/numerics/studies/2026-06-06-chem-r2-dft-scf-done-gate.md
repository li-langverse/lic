...
| Accuracy | Psi4/PySCF H₂ oracle documents reference; energy delta logged in harness JSON (loose tolerance until 401–404 integrals) |
...
# chem-r2 harness + Psi4 H₂ oracle (optional; LGPL)
pip install -r scripts/requirements-ph-sci-chem-dft-competitive.txt
bash scripts/bench-qm-dft-scf-energy-gates.sh
python3 benchmarks/competitive/psi4_sto3g_h2_energy.py
