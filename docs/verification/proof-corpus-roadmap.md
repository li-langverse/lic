...
**Related:** [Provability gaps](provability-gaps.md) · [Contracts and proofs](../language/contracts-and-proofs.md) · [Master plan § 2e–2f](../superpowers/plans/2026-05-14-li-master-plan.md) · [Phase 2e exit gates](../superpowers/plans/2026-05-14-phase-02e-contracts-vc.md) (`scripts/check-phase-2e-gates.sh`)
