...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Slice landed:** CFD 205–210 (`sim_scientific_oracle_checksum_cfd`), FEA 211–216 (`_fea`), QM integrals 401–404 (`_qm_overlap`); 405–432 + external MD still stub.
