...
- **WP-SCI-03/05/06 FEA + CFD tier-2 oracles** — `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_cfd`, `run_fea_tier2_registry`, `run_cfd_tier2_registry`; `algo_fea_linear_elasticity()` (217) and `algo_cfd_lid_driven_cavity()` (218) dispatch; extended `run_algo_registry_tier2.li` and `scientific_oracle_bench.li`.
