...
- **Docs:** GUI UX quality handoff for `gui_ux_tester` + **Doc-c** proof-gap links on open phase plans — [2026-05-30-gui-ux-handoff-plan-cross-links.md](docs/release-notes/2026-05-30-gui-ux-handoff-plan-cross-links.md).
