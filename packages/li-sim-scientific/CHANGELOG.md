...
- **WP-SCI-03 CFD/FEA/QM tier-2 registry dispatch** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; split PDE family dispatch (heat 201–204, CFD 205–211, FEA 212–216, QM 401–432); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity`; extended `run_algo_registry_tier2.li`.
