...
| 2e | Contracts + refinements | [2026-05-14-phase-02e-contracts-vc.md](2026-05-14-phase-02e-contracts-vc.md) | **`check-phase-2e-gates.sh` green** — typed AutoVC, MIR witnesses, open-goals checker; **G-vc** float/opaque still open |
...
|-------|----------------------|-----------|-------------------------|------------------------|
| 2e | VC generation | **G-vc** | `check-phase-2e-gates.sh` green: typed AutoVC, `vc_witness.cpp` MIR linkage, `mir_vc_witness.sh` + `contracts_discharge_corpus.sh` + open-goals checker | [phase-02e plan](2026-05-14-phase-02e-contracts-vc.md), gaps, contracts-and-proofs |
...
- [x] Phase 2e — Contracts + refinements — **v1 gate:** `scripts/check-phase-2e-gates.sh` green — typed `AutoVC.lean`; `lic verify` `witnessed_ensures=` + `mir_return_linked=`; `check-autovc-open-goals.sh`; `vc_emit_contracts.sh` + `mir_vc_witness.sh` + `contracts_discharge_corpus.sh` + `vc_witness.cpp`; call-site **E0304**, refinement **E0305**, **E0303** reject; [phase-02e plan](2026-05-14-phase-02e-contracts-vc.md); **G-vc** float/opaque/loop still **Partial**
