...
2. Read [vision-and-roadmap](https://github.com/li-langverse/roadmap/blob/main/docs/ecosystem/vision-and-roadmap.md) — **north star:** go-to ecosystem for **HPC, scientific computing, and AI**; governance + milestones.
