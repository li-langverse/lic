...
- **WP-SCI-03 Phase 2 CFD/FEA/QM tier-2 kernels** — host-safe SPH/scalar oracles (`sim_scientific_oracle_checksum_cfd`, `_fea`, `_qm_overlap`); `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`; smokes extended.
