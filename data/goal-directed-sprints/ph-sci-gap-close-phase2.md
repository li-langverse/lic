...
**WP-SCI-03 partial:** branch `chore/agent-code_implementer-wp-sci-03-1781042956` — CFD/FEA/QM tier-2 registry dispatch + `run_algo_registry_tier2.li` extensions (stub remains for non-oracle ids).  
