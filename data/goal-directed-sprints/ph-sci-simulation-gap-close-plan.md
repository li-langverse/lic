...
**Status:** Phase 0 complete (BUILD-01 fluids/weather E0201 unroll 2026-06-04); Phase 1 complete; Phase 2 WP-SCI-03 (QM tier-2) + WP-SCI-05 + WP-SCI-06 on `cursor/ph-ml-stage2-dl-spine` (gates: `scripts/ph-sci-phase0-gates.sh`, `scripts/ph-sci-phase1-gates.sh`, `scripts/ph-sci-phase2-gates.sh`)  
