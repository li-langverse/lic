...
- **Landed:** `sim_scientific_oracle_checksum_cfd/fea/qm`, `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`. Remaining stub rows: drug/bio/ml/am/viz/robo/auto families.
