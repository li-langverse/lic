...
- **WP-SCI-03 CFD/FEA/QM tier-2** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; `run_algo_registry` dispatch for pde rows 205–216 and qm 401–432; extended `run_algo_registry_tier2.li`.
