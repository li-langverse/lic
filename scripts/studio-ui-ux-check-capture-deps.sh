...
strict = os.environ.get("STUDIO_UI_UX_CAPTURE_DEPS_STRICT", "0") == "1"
native_only = os.environ.get("STUDIO_UI_UX_CAPTURE_DEPS_NATIVE_ONLY", "0") == "1"
warn_only = os.environ.get("STUDIO_UI_UX_CAPTURE_DEPS_WARN_ONLY", "1") != "0"
...
needs_warn = (not native) or (not html)
strict_fail = (not native) or (not html and not native_only)
