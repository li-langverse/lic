...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **PARTIAL:** tier-2 dispatch for CFD (205–210), FEA (211–216), QM DFT (401–432); stub retained for drug/bio/am/ml registry families.
