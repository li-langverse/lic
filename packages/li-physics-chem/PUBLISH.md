# Publish metadata — PKG-li-physics-chem

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-physics-chem` |
| **Registry name** | `li-physics-chem` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-physics-chem |
