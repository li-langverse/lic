...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **partial (CFD/FEA tier-2 on branch)**
...
- **Progress (2026-06-08):** PDE family split — heat 201–204, CFD 205–211 (`sim_scientific_oracle_checksum_cfd`), FEA 212–216 (`sim_scientific_oracle_checksum_fea`); QM 401–432 remain stub.
