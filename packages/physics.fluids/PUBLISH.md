# Publish metadata — PKG-physics-fluids

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-physics-fluids` |
| **Registry name** | `physics.fluids` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/physics.fluids |
