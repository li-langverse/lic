...
| **Doc-c** | **Phase exit gates** — typechecker, MIR/codegen, HPC plans name **G-*** in exit criteria | `2026-05-14-phase-02-typechecker.md`, `2026-05-14-phase-03-mir-codegen.md`, `2026-05-14-phase-07-native-hpc.md` exit gates cite **G-*** rows |
...
- [x] Phase Doc-c — Phase 02 / 03 / 07 exit gates link **G-*** IDs ([provability-gaps](../verification/provability-gaps.md))
