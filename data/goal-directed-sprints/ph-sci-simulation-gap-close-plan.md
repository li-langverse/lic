...
| **li-sim-scientific** | partial → tier-2 oracle | CPU + `@gpu` MD oracle smoke | Lib builds with open VC; smokes verify | **Real:** 4-particle LJ chain + 1D heat stencil + CFD cavity + FEA bar oracles, `run_multi_physics_at_step`. **Placeholder:** `run_algo_registry_stub` (checksum 1.001) for QM 401–432 | WP-SCI-03 partial (CFD/FEA landed 2026-06-08); LAMMPS/GROMACS external oracle |
...
- **Status:** **partial (2026-06-08)** — CFD 205–210 + FEA 211–216 tier-2 oracles; heat narrowed to 201–204; QM 401–432 remain stub.
