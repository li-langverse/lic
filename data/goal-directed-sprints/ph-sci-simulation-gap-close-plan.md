...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **partial (Phase 2 slice landed)**
...
- **Status:** CFD (205–210), FEA (211–216), QM (401–432) tier-2 Li oracles + dispatch landed; heat narrowed to 201–204; drug/bio/am/viz/robo/auto families still stub.
