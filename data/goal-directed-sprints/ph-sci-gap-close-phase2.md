...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. *(partial: CFD 205–210 + FEA 211–216 tier-2 oracles landed; QM 401–432 remain stub pending chem-r2.)*
