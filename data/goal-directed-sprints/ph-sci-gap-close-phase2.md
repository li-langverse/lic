...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed** — CFD/FEA/QM tier-2 oracles + dispatch (branch `chore/agent-code_implementer-wp-sci-03-clean`).
