...
- **WP-SCI-03 Phase 2 tier-2 kernels** — `sim_scientific_oracle_checksum_cfd`, `_fea`, `_qm`; `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry` for algo IDs 205–210, 211–216, 401–432; `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity`, `algo_cfd_simple`, `algo_fea_linear_elasticity` in `li-sim`.
