...
Implemented `dot_f64_8`, `axpy_f64_8`, `num_dot_axpy_smoke_checksum()` in `math.numerics`; composable + `run_algo` dispatch for algo_id=1. Gates green on isolated clone (`LIC_ROOT=$PWD`, `SIM_PLAN_PACKAGE=li-math-numerics`). Iteration: [20260524-220836](../iterations/20260524-220836.md).
