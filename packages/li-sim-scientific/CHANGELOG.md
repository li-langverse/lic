...
- **WP-SCI-03 tier-2 kernels (Phase 2)** — `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_cfd`; split PDE registry dispatch (201–204 heat, 205–210 CFD, 211–216 FEA); `vertical_fea_linear_elasticity` / `vertical_cfd_lid_driven_cavity`; extended `run_algo_registry_tier2.li`.
