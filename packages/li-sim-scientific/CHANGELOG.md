...
- **WP-SCI-03 tier-2 kernels (slice 2)** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm_dft`; `run_algo_registry` CFD (205–210), FEA (211–216), QM (401–432) tier-2 dispatch; heat narrowed to 201–204; `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity`; smokes extended.
