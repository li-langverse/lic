...
Package repos ship minimal [GitHub Pages handbooks](satellite-handbook-pages.md) linking here. Until Pages deploy on `main`, use in-repo `docs/handbook.md` in each repo.
