...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed** (`chore/agent-code_implementer-wp-sci-03-1781039515`): CFD 205–210, FEA 211–216, QM 401–432 tier-2 dispatch; stub only for undocumented IDs.
