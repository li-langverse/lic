...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **PARTIAL landed** — tier-2 dispatch for algo ids 205–210 (CFD), 211–216 (FEA), 401–404 (QM overlap); stub retained for 405–432 (DFT SCF) pending chem oracle wiring.
