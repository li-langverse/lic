# Publish metadata — PKG-li-sim-robotics

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-sim-robotics` |
| **Registry name** | `li-sim-robotics` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-sim-robotics |
