...
| **G-async** | Partial | `await` + `when_all` borrow proofs; [sender/receiver spec](../superpowers/specs/2026-06-07-li-sender-receiver-async-scheduling-surface.md) (lic#125) |
...
| **G-async** | `@async` / `raises Async` / `when_all` | Structured concurrency proofs | **Partial** — `await` parse + `when_all` borrow reject; codegen open | **2+**, **7d** | `li-tests/effects/`, [sender/receiver spec](../superpowers/specs/2026-06-07-li-sender-receiver-async-scheduling-surface.md) |
