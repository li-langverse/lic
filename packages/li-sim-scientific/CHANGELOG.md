...
- **WP-SCI-03 Phase 2 tier-2 kernels** — `sim_scientific_oracle_checksum_cfd`, `_fea`, `_qm`; `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry`; heat dispatch narrowed to 201–204; smokes `run_algo_registry_tier2.li` extended for CFD/FEA/QM rows.
