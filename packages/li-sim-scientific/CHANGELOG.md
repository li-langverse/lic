...
- **WP-SCI-03 CFD/FEA tier-2 oracles** — split PDE registry band 201–216: heat (201–204), `sim_scientific_oracle_checksum_cfd` lid-driven cavity (205–210), `sim_scientific_oracle_checksum_fea` linear bar (211–216); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`; extend `run_algo_registry_tier2.li`.
...
- `run_algo_registry` PDE band split: heat 201–204, CFD 205–210, FEA 211–216 (was heat oracle for all 201–216); `li_sim_scientific_version` → 7.
