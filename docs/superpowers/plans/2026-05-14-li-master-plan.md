...
| **Doc-c₁** | **Phase exit gates** — phase plans 02 / 03 / 07 cite **G-*** register rows at exit | `2026-05-14-phase-02-typechecker.md`, `2026-05-14-phase-03-mir-codegen.md`, `2026-05-14-phase-07-native-hpc.md` |
...
- [x] **Doc-c₂** — spec stubs (decorator, math surface) use Doc-c **G-*** format  
...
- [x] Phase Doc-c — Phase 02 / 03 / 07 exit gates cite **G-*** register rows; spec stubs normalized (**Doc-c₁** + **Doc-c₂**)
