...
| **li-sim-scientific** | partial → tier-2 oracle | CPU + `@gpu` MD oracle smoke | Lib builds with open VC; smokes verify | **Real:** 4-particle LJ chain + 1D heat stencil + CFD cavity + FEA truss + QM SCF oracles, `run_multi_physics_at_step`. **Placeholder:** `run_algo_registry_stub` (checksum 1.001) for drug/bio/ml/am families (501+) | WP-SCI-03 partial; no LAMMPS/GROMACS external oracle |
...
- **Status:** partial (2026-06-08) — CFD 205–210, FEA 211–216, QM 401–432 tier-2 oracles landed; heat narrowed to 201–204; stub remains for drug/bio/ml/am/robo/auto/viz families (501+).
