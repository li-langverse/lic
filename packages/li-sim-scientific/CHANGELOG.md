...
- **WP-SCI-03 QM tier-2 dispatch** — `sim_scientific_oracle_checksum_qm`, `run_qm_tier2_registry` for registry ids 401–432 (`chem_dft_energy_kernel_hartree`); `run_algo_registry_tier2.li` extended for ids 401 and 418.
