...
1. ~~**WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`.~~ **DONE** — CFD 501–523, FEA 601–610, QM 401–432 tier-2 oracles; `run_algo_registry_qm_tier2.li` smoke.
