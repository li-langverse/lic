...
- Algo 105 neighbor-cell list: `md_mic`, `md_cell_index_1d`, `md_neighbor_cell_list_force_sum`, and `md_neighbor_cell_list_smoke_checksum` in pure Li; C parity @ N=256 in `scripts/md-neighbor-cell-parity.c`.
