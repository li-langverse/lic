...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** tier-2 dispatch for PDE heat 201–204, CFD 205–210, FEA 211–216, QM 401–432; stub retained for drug/bio/ml/am/viz/auto families only.
