...
- **WP-SCI-03 QM tier-2 registry** — `sim_scientific_oracle_checksum_qm`, `run_qm_tier2_registry` for algo_registry **401–432** (`chem_dft_energy_kernel_hartree` oracle); `run_algo_registry_tier2.li` + `import_qm_dft_smoke.li` extended; stub documented for drug/bio/additive/game/auto rows only.
