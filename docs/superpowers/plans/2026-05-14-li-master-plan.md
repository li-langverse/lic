...
- [ ] **Vision-LLM** — LLM-first + agent JSON diagnostics — **partial:** `lic check --format=json`, `lic diagnose`, `diagnostic-v1` schema, handover docs, manifest stub ([llm-first spec](../specs/2026-05-16-li-llm-first-design.md), [agent-handover](../ecosystem/agent-handover-formats.md)); competitive agent-surface gaps in [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) ([#65](https://github.com/li-langverse/lic/issues/65))
