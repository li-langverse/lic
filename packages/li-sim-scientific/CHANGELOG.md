...
- `run_algo_registry` splits PDE family: heat 201–204, CFD 205–210, FEA 211–216; QM 401–432 use `chem_dft_scf_iteration_scaffold` oracle (not stub 1.001); `li_sim_scientific_version` → 7.
