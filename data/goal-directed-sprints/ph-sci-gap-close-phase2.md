...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** FEA 511–514 + CFD 521–523 tier-2 oracles landed; QM 401–432 remain stub (checksum 1.001).
