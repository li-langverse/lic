...
- **WP-SCI-03 tier-2 CFD dispatch** — `sim_scientific_oracle_checksum_cfd`, `run_algo_registry` routes algo ids 205–210 to CFD oracle (heat 201–204/211–216 unchanged); smoke `run_algo_registry_tier2.li` adds `cfd206` row.
