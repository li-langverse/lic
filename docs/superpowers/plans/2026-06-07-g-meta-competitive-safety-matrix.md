...
|-----|-----|-------------|-----------|
| **A** | REQ-GMETA-SCHEMA | **Matrix schema** — rows × columns frozen | Table header approved in PR review |
| **B** | REQ-GMETA-SOURCES | **Source citations** | Each cell cites primary source |
| **C** | REQ-GMETA-DOC | **One-page matrix** | `docs/ecosystem/competitive-safety-matrix.md` ≤ ~80 lines |
| **D** | REQ-GMETA-VLLM | **Vision-LLM linkage** | Agent surfaces § maps Li diagnostics vs competitors |
| **E** | REQ-GMETA-XLINK | **Cross-links** | `plan-cross-links.md`, master plan, `provability-gaps.md` |
...
| **Vision-LLM** | **Partial → Partial** | Matrix lists agent-surface gaps; closure via #425 / #464 |

## Implementation status

- [x] **REQ-GMETA-DOC** — [competitive-safety-matrix.md](../../ecosystem/competitive-safety-matrix.md) merged via code_implementer (#65)
- [x] **REQ-GMETA-XLINK** — cross-links in same PR
- [x] **REQ-GMETA-CI** — `check-doc-provability-claims.sh`
