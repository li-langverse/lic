...
- **WP-SCI-03 Phase 2 QM tier-2** — `sim_scientific_oracle_checksum_qm`, `run_qm_tier2_registry` for algo ids 401–432 (`chem_dft_gpu_energy_checksum` oracle); `run_algo_registry_tier2.li` extended for ids 401/418.
