...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** CFD/FEA/QM tier-2 oracles + registry dispatch landed; stub 418 documented.
