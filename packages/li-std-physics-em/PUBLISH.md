# Publish metadata — PKG-li-std-physics-em

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-std-physics-em` |
| **Registry name** | `li-std-physics-em` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-std-physics-em |
