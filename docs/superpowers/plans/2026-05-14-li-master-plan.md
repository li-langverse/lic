...
**Canonical register:** [docs/verification/provability-gaps.md](../verification/provability-gaps.md) (`G-*` IDs). **Navigation map:** [plan cross-links](../../ecosystem/plan-cross-links.md).
