...
- **WP-SCI-03 Phase 2 tier-2 kernels** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; split PDE registry dispatch (heat 201–204, CFD 205–211, FEA 212–216, QM 401–432); vertical ids `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity`; smokes extended in `run_algo_registry_tier2.li`, `scientific_oracle_bench.li`.
...
- `li_sim_scientific_version` → 7 (WP-SCI-03 Phase 2 CFD/FEA/QM tier-2 dispatch).
