...
- **WP-SCI-03 tier-2 kernels (Phase 2)** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; split `run_algo_registry` dispatch for heat (201–204), CFD (205–210), FEA (211–216), QM (401–432, 418 stub); vertical ids `vertical_fea_linear_elasticity`, `vertical_cfd_lid_driven_cavity`; extend `run_algo_registry_tier2.li`.
