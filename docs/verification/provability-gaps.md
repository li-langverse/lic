...
| **G-meta** | Missing | Compiler ↔ Lean equivalence (research); positioning: [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) |
...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) | long-term | Not started; competitive positioning in [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) |
