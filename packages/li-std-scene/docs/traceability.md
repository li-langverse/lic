# Traceability — PKG-li-std-scene

<!-- DOC-traceability-PKG-li-std-scene -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-std-scene | This repository |
...
| Test | T-PKG-li-std-scene-smoke | `li-tests/smoke/builds.li` |
