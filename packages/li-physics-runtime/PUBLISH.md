# Publish metadata — PKG-li-physics-runtime

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-li-physics-runtime` |
| **Registry name** | `li-physics-runtime` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/li-physics-runtime |
