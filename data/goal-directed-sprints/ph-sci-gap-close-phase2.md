...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed** — branch `chore/agent-code_implementer-wp-sci-03-cfd-fea-qm-1781015390` (QM 401–432, CFD 205–210, FEA 211–216 tier-2 oracles).
