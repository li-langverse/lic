...
- **WP-SCI-03 Phase 2 tier-2 CFD/FEA/QM** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); heat dispatch narrowed to 201–204; `run_algo_registry_tier2.li` extended.
