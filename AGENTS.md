...
4. Read `docs/superpowers/plans/2026-05-14-li-master-plan.md` — current **PH-** phase; [plan cross-links](docs/ecosystem/plan-cross-links.md) and [provability gaps](docs/verification/provability-gaps.md) (**G-*** honesty).
