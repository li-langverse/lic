...
| **E** | REQ-GMETA-XLINK | **Cross-links** | `plan-cross-links.md`, master plan note, `provability-gaps.md` G-meta footnote |
...
**Implemented** — matrix merged on `main` via code_implementer PR; close [#65](https://github.com/li-langverse/lic/issues/65) with `already_implemented`.
