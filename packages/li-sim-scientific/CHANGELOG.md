...
- **WP-SCI-03 CFD/FEA/QM tier-2 registry** — `sim_scientific_oracle_checksum_cfd` (SPH poly6 kernel row), `sim_scientific_oracle_checksum_fea` (bar truss Jacobi scaffold), `sim_scientific_oracle_checksum_qm_dft` (STO-3G SCF scaffold); `run_cfd_tier2_registry` (501–523), `run_fea_tier2_registry` (601–610), `run_qm_tier2_registry` (401–432); smokes `run_algo_registry_tier2.li`, `run_algo_registry_qm_tier2.li`; version bump + echem drift denom guard.
