...
| **G-oop** | Full OOP | Methods, traits, inheritance, cross-module encapsulation | **Partial** — inheritance + override (**2j-d**); traits (**2j-e**) open | **2j** | `li-tests/encapsulation/inheritance_*.li`, `override_mismatch.li` |
