...
- **WP-SCI-03 FEA/CFD tier-2 kernels** — `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_cfd`, `run_fea_tier2_registry` (211–216), `run_cfd_tier2_registry` (205–210); heat dispatch narrowed to 201–204; smokes extended.
