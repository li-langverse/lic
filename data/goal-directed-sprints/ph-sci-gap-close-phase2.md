...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** CFD/FEA tier-2 oracles + smokes landed; QM rows remain documented stub (`1.001`).
