...
| **li-sim-scientific** | partial → tier-2 oracle | CPU + `@gpu` MD oracle smoke | Lib builds with open VC; smokes verify | **Real:** MD/heat/CFD/FEA/QM tier-2 `run_algo_registry` dispatch (ids 101–117, 201–204, 205–210, 211–216, 401–432); echem 433–435; `run_multi_physics_at_step`. **Placeholder:** `run_algo_registry_stub` for drug/bio/ml/am/viz/robo/auto families; no LAMMPS/GROMACS external oracle | WP-SCI-04 viz; WP-PLAT-05 MD external oracle |
...
- **Status:** partial (2026-06-09) — CFD 205–210, FEA 211–216, QM 401–432 tier-2 oracles landed; external MD (WP-PLAT-05) and drug/bio/am/ml families still stub.
...
- **Landed (slice):** tier-2 dispatch for CFD (205–210), FEA (211–216), QM overlap (401–404), QM DFT (405–432); stub retained for drug/bio/am/ml families. Smokes: `run_algo_registry_tier2.li`, `run_algo_registry_qm_tier2.li`.
