...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for QM rows (401–432); `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak. **WP-SCI-03 partial (2026-06-08):** CFD ids 205–211 + FEA ids 212–216 tier-2 oracles landed; heat narrowed to 201–204.
