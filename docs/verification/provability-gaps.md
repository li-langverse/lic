...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) | long-term | Not started — positioning only in [competitive-safety-matrix](../ecosystem/competitive-safety-matrix.md); does not close this row |
