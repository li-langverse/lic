...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** tier-2 CFD/FEA/QM oracles + registry dispatch landed; external MD oracle (WP-PLAT-05) still open.
