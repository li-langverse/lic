...
<!-- DOC-ecosystem-stub-agent-coordination.md -->

**Canonical doc:** [agent-coordination.md](https://github.com/li-langverse/roadmap/blob/main/docs/ecosystem/agent-coordination.md) in [`li-langverse/roadmap`](https://github.com/li-langverse/roadmap).

Do not edit ecosystem policy here — open a PR to the roadmap repo (human merge for governance paths).

## Related

- [org-backup.md](../ecosystem/org-backup.md) — agents **must not** run backup scripts or read `.env.github.backup`
