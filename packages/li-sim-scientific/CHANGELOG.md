...
- **WP-SCI-03 QM tier-2 registry** — `sim_scientific_oracle_checksum_qm`, `run_qm_tier2_registry`, `algo_registry_is_qm` for algo ids 401–432 (`chem_dft_scf_iteration_scaffold` SCF oracle); `run_algo_registry_tier2.li` + `scientific_oracle_bench.li` extended; `li_sim_scientific_version` → 7.
