...
| **G-meta** | Missing | Compiler ↔ Lean equivalence (research) — positioning matrix: [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) |
...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) | long-term | Not started; [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) documents honest positioning vs Carbon/Mojo/Rust |
