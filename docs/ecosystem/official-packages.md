...
**Upstream notifications:** [Master plan § Cross-repo notifications](../superpowers/plans/2026-05-14-li-master-plan.md#cross-repo-dependency-notifications-every-official-package) — every row must receive GitHub dispatch / Dependabot when a `depends_on` repo releases.
