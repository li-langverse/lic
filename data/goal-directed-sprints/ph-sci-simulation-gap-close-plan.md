...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for drug/bio/am/ml families; `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
...
| **li-sim-scientific** | partial → tier-2 oracle | CPU + `@gpu` MD oracle smoke | Lib builds with open VC; smokes verify | **Real:** MD/heat/CFD/FEA/QM tier-2 `run_algo_registry` dispatch (ids 101–117, 201–204, 205–210, 211–216, 401–404); echem 433–435; `run_multi_physics_at_step`. **Placeholder:** `run_algo_registry_stub` for drug/bio/ml/am/viz/robo/auto families; no LAMMPS/GROMACS external oracle | WP-SCI-04 viz; WP-PLAT-05 MD external oracle |
...
- **Landed (slice):** tier-2 dispatch for CFD (205–210), FEA (211–216), QM (401–432 via `chem_dft_energy_kernel_hartree`); stub retained for drug/bio/am/ml families. Smokes: `run_algo_registry_tier2.li`, `scientific_oracle_bench.li`.
