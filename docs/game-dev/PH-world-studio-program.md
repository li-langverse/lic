...
**Status:** Ready for merge (impl-48 on `feat/world-studio-impl-1`) · [merge checklist](MERGE-world-studio-checklist.md) · [demo showcase](demo-showcase.md)  
...
| **160 composable** · milestone 160 · assets/voxel/ML/chem + studio | Done |
