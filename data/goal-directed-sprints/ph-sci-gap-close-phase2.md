...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. *(partial — tier-2 QM/CFD/FEA oracles + dispatch on branch `chore/agent-code_implementer-wp-sci-03-1781031200`)*
