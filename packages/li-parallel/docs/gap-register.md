...
| WP-PAR-48 | Whole-catalog dual-mode audit | **IN PROGRESS** — `--scope all` tags every `lang=li` row; lipar-suite preserves serial snapshot across parallel full-suite pass |
