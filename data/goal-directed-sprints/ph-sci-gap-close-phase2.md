...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. *(2026-06-07: FEA 211–216 + CFD 205–210 tier-2 oracles landed; QM 401–432 remain stub.)*
