...
**Agent verification (2026-06-04):** run `code_implementer-1780595491219` — rebased PR [#766](https://github.com/li-langverse/lic/pull/766) onto `main`; `scripts/lib/lic-bin-select.sh` gains `li_has_runnable_lic` + `LIC_ROOT` sibling lookup (supersedes duplicate `lic-runnable.sh`).
