...
- **Proof-db math axioms (seed):** `proof-db/math/` — 9× `AX-MATH-*`, 3 target lemmas — [2026-05-25-proof-db-math-axioms.md](docs/release-notes/2026-05-25-proof-db-math-axioms.md).
