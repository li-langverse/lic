...
**Last updated:** 2026-06-09 · **main @** `f3ea736e` (Phase 0/1 + echem merged; WP-SCI-03 CFD/FEA/QM tier-2 in flight)  
...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed (2026-06-09):** tier-2 dispatch for 205–216 (CFD/FEA) and 401–432 (QM); stub remains for drug/robo/auto rows.
