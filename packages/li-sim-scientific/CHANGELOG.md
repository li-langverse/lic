...
- **WP-SCI-03 Phase 2 tier-2 oracles** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry` dispatch for registry rows 205–210, 211–216, 401–432; `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity` in `li-sim`; extended `run_algo_registry_tier2.li`.
