...
- `md_neighbor_cell_list_*` APIs for algo 105: cell-shell LJ force sum + composable checksum gate; N=256 brute/cell parity in `scripts/md-neighbor-cell-parity.c` (`sim-p1-md-neighbor-cell`).
