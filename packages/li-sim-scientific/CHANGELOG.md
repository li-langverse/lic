...
- **WP-SCI-03 QM tier-2 registry** — `sim_scientific_oracle_checksum_qm_dft`, `run_qm_tier2_registry` for algo_registry 401–432 (`chem_dft_scf_iteration_scaffold` energy witness); `run_algo_registry_tier2.li` asserts non-stub QM dispatch; stub documented for drug/bio/ml/am/viz/robo/auto only.
