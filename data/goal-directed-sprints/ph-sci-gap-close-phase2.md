...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** CFD 205–211, FEA 212–216, QM 401–432 tier-2 oracles landed; drug/bio/ml/am/viz/robo/auto rows remain documented stubs.
