...
| **T6** | `ml_matmul_lkir_logical_32` (64×4×4 blocked tiles), `ml_matmul_32_lkir.li` smoke, `bench-ph-ml-lkir-matmul-32.sh` with WSL delegation on Windows hosts and `ratio_vs_li` vs NumPy 32×32 |
