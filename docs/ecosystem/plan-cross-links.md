...
| `2026-06-07-vision-llm-manifest-ship-gate.md` | **Vision-LLM** — manifest stub → CI-backed agent entry ([#464](https://github.com/li-langverse/lic/issues/464)) |
...
| **Vision-LLM** — Agent JSON diagnostics | — | [2026-05-16-li-llm-first-design.md](../superpowers/specs/2026-05-16-li-llm-first-design.md) · [manifest ship gate](../superpowers/plans/2026-06-07-vision-llm-manifest-ship-gate.md) ([#464](https://github.com/li-langverse/lic/issues/464)) |
