...
| **D** | REQ-GMETA-VLLM | **Vision-LLM linkage** | Matrix § “Agent surfaces” maps Li diagnostics vs competitors |
| **E** | REQ-GMETA-XLINK | **Cross-links** | `plan-cross-links.md`, master plan, `provability-gaps.md` G-meta cite matrix |
| **F** | REQ-GMETA-CI | **Doc CI** | `./scripts/check-doc-provability-claims.sh` exit 0 |

## Implementation status

**Shipped:** [competitive-safety-matrix.md](../../ecosystem/competitive-safety-matrix.md) on implementation PR (sub-phases A–F). Close [#65](https://github.com/li-langverse/lic/issues/65) when merged on `main`.
