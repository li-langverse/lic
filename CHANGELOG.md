...
- **PH-7d / G-dec decorator telemetry:** `@cpu` on `def` now survives MIR lowering and `lic verify` reports `mir_cpu_def` — [2026-06-08-gdec-mir-cpu-decorator.md](docs/release-notes/2026-06-08-gdec-mir-cpu-decorator.md).
