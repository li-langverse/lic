...
def vc_sim_scientific_oracle_checksum_cfd_ensures_0 (result : Float) : Prop := (result > (1 : Float))
...
def vc_sim_scientific_oracle_checksum_cfd_call1_cfd_oracle_lid_diffuse_step_requires_0 (nu : Float) : Prop := (nu > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call1_cfd_oracle_lid_diffuse_step_requires_1 (dt : Float) : Prop := (dt > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call1_cfd_oracle_lid_diffuse_step_requires_2 (dx : Float) : Prop := (dx > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call2_cfd_oracle_lid_diffuse_step_requires_0 (nu : Float) : Prop := (nu > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call2_cfd_oracle_lid_diffuse_step_requires_1 (dt : Float) : Prop := (dt > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call2_cfd_oracle_lid_diffuse_step_requires_2 (dx : Float) : Prop := (dx > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call3_cfd_oracle_lid_diffuse_step_requires_0 (nu : Float) : Prop := (nu > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call3_cfd_oracle_lid_diffuse_step_requires_1 (dt : Float) : Prop := (dt > (0 : Float))
def vc_sim_scientific_oracle_checksum_cfd_call3_cfd_oracle_lid_diffuse_step_requires_2 (dx : Float) : Prop := (dx > (0 : Float))
