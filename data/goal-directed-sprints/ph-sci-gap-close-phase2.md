...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. *(CFD/FEA tier-2 slice landed: oracles + registry dispatch 205–216; QM rows still stub.)*
