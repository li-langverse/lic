...
- **WP-SCI-03 Phase 2 QM tier-2** — QM family 401–432 dispatch via `run_algo_registry_stub` + `chem_dft_gpu_energy_checksum`; `sim_scientific_oracle_checksum_qm_dft`, `run_qm_tier2_registry`; smoke `run_algo_registry_qm_tier2.li` (algo 418 ≠ stub 1.001).
