...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **PARTIAL:** tier-2 dispatch for CFD (205–210), FEA (211–216), QM overlap (401–404) on branch `chore/agent-code_implementer-wp-sci-03-cfd-fea-qm-202606091345`.
