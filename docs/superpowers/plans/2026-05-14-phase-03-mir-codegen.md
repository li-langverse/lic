...
- [x] Bounds check calls present in IR for dynamic index — **[G-bnd](../../verification/provability-gaps.md#g-bnd)** partial (release path still uses `li_bounds_fail` for unproved indices)
