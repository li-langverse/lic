...
| **G-meta** | Missing | Compiler ↔ Lean equivalence (research) — competitive positioning doc: [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) (does not close this row) |
...
| **G-meta** | Compiler correctness | C++ compiler ≡ Lean semantics | **Missing** (research) — see [competitive-safety-matrix.md](../ecosystem/competitive-safety-matrix.md) for honest positioning vs Carbon/Mojo/Rust | long-term | Not started |
