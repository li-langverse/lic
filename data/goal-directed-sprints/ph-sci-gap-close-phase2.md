...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. *(slice 1 landed: CFD 205–210, FEA 211–216, QM 401–432 tier-2 oracles; heat 201–204 only.)*
