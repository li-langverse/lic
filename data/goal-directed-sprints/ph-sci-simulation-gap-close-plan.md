...
**Status:** Phase 0 complete; Phase 1 complete on `cursor/ph-ml-stage2-dl-spine` (gates: `scripts/ph-sci-phase0-gates.sh`, `scripts/ph-sci-phase1-gates.sh`, 2026-06-04)  
