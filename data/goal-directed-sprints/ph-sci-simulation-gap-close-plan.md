...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for CFD/FEA rows (QM 401–432 tier-2 landed 2026-06-09); `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
