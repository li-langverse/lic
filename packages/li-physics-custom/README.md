...
Li package li-physics-custom

## Build

```bash
lic build src/lib.li -o li-physics-custom
```
...
| ID | Link |
|----|------|
| Package | `PKG-li-physics-custom` |
| Org repo | https://github.com/li-langverse/li-physics-custom |
