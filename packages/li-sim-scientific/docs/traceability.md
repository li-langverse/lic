# Traceability — PKG-li-sim-scientific

<!-- DOC-traceability-PKG-li-sim-scientific -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-sim-scientific | This repository |
...
| Test | T-PKG-li-sim-scientific-smoke | `li-tests/smoke/builds.li` |
