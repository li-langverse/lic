...
- [ ] **Vision-LLM** — LLM-first + agent JSON diagnostics — **partial:** `lic check --format=json`, `lic diagnose`, `diagnostic-v1` schema, handover docs, manifest stub ([llm-first spec](../specs/2026-05-16-li-llm-first-design.md), [agent-handover](../ecosystem/agent-handover-formats.md)); agent-surface gaps vs Carbon/Mojo/Rust in [competitive-safety-matrix](../ecosystem/competitive-safety-matrix.md) — **G-meta positioning only**, row stays open until Done gates ([#425](https://github.com/li-langverse/lic/issues/425), [#464](https://github.com/li-langverse/lic/issues/464))
