# Traceability — PKG-li-sim-automotive

<!-- DOC-traceability-PKG-li-sim-automotive -->

| Type | ID | Artifact |
|------|-----|----------|
| Package | PKG-li-sim-automotive | This repository |
...
| Test | T-PKG-li-sim-automotive-smoke | `li-tests/smoke/builds.li` |
