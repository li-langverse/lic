...
- **WP-SCI-03 Phase 2 CFD/FEA tier-2** — `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_cfd_lid`, `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216); `vertical_fea_linear_elasticity` / `vertical_cfd_lid_driven_cavity`; smokes `fea_cfd_oracle_smoke.li`, `run_algo_registry_tier2.li` extended for algo 206/214.
