...
- [x] Bounds check calls present in IR for dynamic index — **G-bnd** partial (release path may still emit `li_bounds_fail`; see [provability-gaps](../../verification/provability-gaps.md#g-bnd))
