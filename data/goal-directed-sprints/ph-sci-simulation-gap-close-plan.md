...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **partial** (CFD/FEA/QM tier-2 landed)
...
- **Landed (2026-06-08):** `sim_scientific_oracle_checksum_cfd/fea/qm`, dispatch for algo ids 205–210, 211–216, 401–432; smoke extended. Stub remains for drug/bio/am/viz/robo/auto families.
