...
- **WP-SCI-03 Phase 2 — CFD/FEA/QM tier-2 registry dispatch** — `sim_scientific_oracle_checksum_cfd` (SPH poly6), `sim_scientific_oracle_checksum_fea` (truss Jacobi), `sim_scientific_oracle_checksum_qm_dft` (chem SCF scaffold); `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`; smokes `run_algo_registry_tier2.li`, `run_algo_registry_qm_tier2.li`.
