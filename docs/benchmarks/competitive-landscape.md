...
Planned **`lammps`** / **`gromacs`** validity columns for `md_lennard_jones` — not language runtimes. Registry: `benchmarks/competitive/md_oracle.toml`. Plan: [competitive-engines-plan.md](competitive-engines-plan.md). CI stub: `scripts/bench-md-external-oracle-stub.sh`.
