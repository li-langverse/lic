...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** tier-2 CFD (205–210), FEA (211–216), QM (401–432) oracles + registry dispatch landed; stub remains for drug/bio/am rows.
