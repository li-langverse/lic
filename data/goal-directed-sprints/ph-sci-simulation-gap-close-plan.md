...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for drug/auto/am rows; `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
...
- **Status:** CFD (501–523), FEA (601–610), QM (401–432) tier-2 oracles + smokes landed; drug/auto/am rows still stub.
