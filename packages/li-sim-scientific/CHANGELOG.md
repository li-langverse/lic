...
- **sim-p2-qm-dft-scf (algo_id=418)** — `sim_scientific_oracle_checksum_qm_dft_scf`, `run_qm_dft_scf_energy_smoke`, `run_qm_dft_scf_tier2_registry`; H₂ STO-3G SCF energy via `echem_dft_h2_energy_hartree`; smoke `qm_dft_scf_interface_smoke.li`.
