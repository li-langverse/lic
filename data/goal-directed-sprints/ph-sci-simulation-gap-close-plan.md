...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` for QM (401–432) and non-science families; CFD/FEA rows 205–216 now tier-2 oracles (WP-SCI-03 partial); `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
