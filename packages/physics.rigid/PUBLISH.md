# Publish metadata — PKG-physics-rigid

| Field | Value |
|-------|--------|
| **PKG id** | `PKG-physics-rigid` |
| **Registry name** | `physics.rigid` (lip, phase 8d) |
| **Maintainer** | li-langverse |
| **Repository** | https://github.com/li-langverse/physics.rigid |
