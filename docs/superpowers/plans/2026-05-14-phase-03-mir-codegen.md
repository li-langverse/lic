...
- [x] Bounds check calls present in IR for dynamic index — **[G-bnd](../../verification/provability-gaps.md#g-bnd)** partial ([bounds-release-path](../../verification/bounds-release-path.md); `check_release_bounds_ir.sh`)
