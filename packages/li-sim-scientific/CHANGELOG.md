...
- **WP-SCI-03 Phase 2 tier-2 CFD/FEA/QM oracles** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); split PDE heat dispatch (201–204); extended `run_algo_registry_tier2.li` and `scientific_oracle_bench.li`.
...
- `li_sim_scientific_version` → 7 (WP-SCI-03 Phase 2 CFD/FEA/QM registry dispatch).
