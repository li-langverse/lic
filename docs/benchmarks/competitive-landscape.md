...
| Kokkos | Performance portability (4.6.x pin → [benchmarks#27](https://github.com/li-langverse/benchmarks/issues/27)) | `MemorySpace`/`ExecutionSpace` policy → [lic#110](https://github.com/li-langverse/lic/issues/110); LLVM/OpenMP alignment |
