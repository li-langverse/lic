...
- **WP-SCI-03 Phase 2 slice** — `sim_scientific_oracle_checksum_cfd`, `_fea_bar`, `_qm`; `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry` for algo rows 205–210 / 211–216 / 401–432; heat narrowed to 201–204; smoke `run_algo_registry_tier2.li` extended.
