...
- **WP-SCI-03 Phase 2 tier-2 registry** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm_dft`; `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry` for algo_ids 205–210, 211–216, 401–432; `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity`; extended `run_algo_registry_tier2.li`.
