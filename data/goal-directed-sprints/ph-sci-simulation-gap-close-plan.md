...
| Phase 2 | 11 | **OPEN** (WP-SCI-03 QM tier-2 partial) | WP-SCI-04 viz |
| Phase 3 | 3 | **OPEN** | WP-SCI-GPU-VENDOR-01 |
| **Total** | **33** | **19 done (~58%)** | |

### Top 3 P0 items (Phase 2 — start here)

1. **WP-SCI-03** — QM ids 401–432 tier-2 via `chem_dft_energy_kernel_hartree` (**partial**); remaining: CFD/FEA registry rows, per-algo kernels.
