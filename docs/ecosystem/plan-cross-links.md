...
| Artifact | Role |
|----------|------|
| [competitive-safety-matrix.md](competitive-safety-matrix.md) | One-page matrix: proof-by-default, safety model, interop, agent surfaces |
| [provability-gaps.md](../verification/provability-gaps.md) **G-meta** | Honest limit — matrix does **not** close compiler ≡ Lean gap |
| [2026-05-16-li-llm-first-design.md](../superpowers/specs/2026-05-16-li-llm-first-design.md) | Vision-LLM agent column outcomes |
