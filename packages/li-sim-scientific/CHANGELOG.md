...
- **WP-SCI-03 Phase 2 tier-2 kernels** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; `run_cfd_tier2_registry`, `run_fea_tier2_registry`, `run_qm_tier2_registry` for algo ids 205–210 / 211–216 / 401–432; heat dispatch narrowed to 201–204; smoke `run_algo_registry_tier2.li` extended.
