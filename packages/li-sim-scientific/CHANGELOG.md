...
- **WP-SCI-03 CFD/FEA tier-2 registry** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_cfd_tier2_registry` (511–514), `run_fea_tier2_registry` (521–523); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity` in `li-sim`; extended `run_algo_registry_tier2.li`.
...
- `li_sim_scientific_version` → 7 (WP-SCI-03 CFD/FEA tier-2 dispatch).
