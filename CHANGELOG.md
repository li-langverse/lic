...
- **PH-7d / G-dec decorator MIR elaboration:** `@cpu` / proc `@vectorized` / proc `@parallel(disjoint=)` on `def` now elaborate to MIR telemetry and `ArraySimdScope` — [2026-06-08-gdec-mir-elaboration.md](docs/release-notes/2026-06-08-gdec-mir-elaboration.md).
