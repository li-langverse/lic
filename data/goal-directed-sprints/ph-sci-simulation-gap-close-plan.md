...
#### WP-SCI-03 — `run_algo_registry` real kernels (extends existing ID) — **partial (2026-06-09)**
...
- **Landed:** CFD (205–210 SPH kernel), FEA (211–216 bar truss), QM overlap (401–404), QM DFT SCF (405–432 via `chem_dft_scf_iteration_scaffold`); `vertical_cfd_lid_driven_cavity`, `vertical_fea_linear_elasticity`.
