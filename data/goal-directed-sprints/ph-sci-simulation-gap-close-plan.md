...
- **Landed (2026-06-08):** CFD rows 205–210 → `sim_scientific_oracle_checksum_cfd`; FEA rows 211–216 → `sim_scientific_oracle_checksum_fea`; heat narrowed to 201–204. QM 401–432 remain documented stub (1.001).
