...
- **sim-p2-qm-dft-scf / lic#478** — `sim_scientific_oracle_checksum_qm_dft_scf`, `run_qm_dft_scf_energy_smoke`, `run_qm_dft_scf_tier2_registry`, `algo_qm_dft_scf_energy()` (418) dispatch via `chem_dft_scf_h2_iteration_scaffold`; smoke `qm_dft_scf_energy_smoke.li`.
