...
- [ ] Phase 2f — Lean 4 verify — **partial:** auto-discharge (`True`, `decreases`, return/const/mirror `ensures`); `contracts_discharge_corpus.sh`; `sqrt_contract` abs/refinement open; `lic verify --strict-lean`
