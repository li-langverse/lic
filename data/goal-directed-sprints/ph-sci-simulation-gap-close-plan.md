...
- **Remaining lib gaps (Phase 2):** `run_algo_registry_stub` only for undocumented registry IDs (CFD/FEA/QM tier-2 landed 2026-06-09); `li-sim-viz` compose-only; scene `native_pixels` stub; particles MD force accumulation still weak.
...
- **Status:** **partial** (2026-06-09) — CFD (205–210), FEA (211–216), QM (401–432) tier-2 Li oracles; MD external oracle still WP-PLAT-05.
