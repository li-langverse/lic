...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); **partial landed** — CFD/FEA/QM tier-2 dispatch + `run_algo_registry_tier2_cfd_fea_qm.li` (branch `chore/agent-code_implementer-wp-sci-03-*`).
