...
- **sim-p2-qm-dft-scf (algo_id=418)** — `run_qm_dft_scf_energy_smoke`, `run_qm_dft_scf_tier2_registry`, `qm_dft_scf_interface_smoke.li`; H2 STO-3G LDA stub via `physics.quantum`; `li_sim_scientific_version` → 7.
