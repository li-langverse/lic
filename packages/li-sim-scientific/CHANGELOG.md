...
- **WP-SCI-03 Phase 2 — CFD/FEA/QM tier-2 registry** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `sim_scientific_oracle_checksum_qm`; `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); heat dispatch narrowed to 201–204; smokes `scientific_oracle_bench.li`, `run_algo_registry_tier2.li` extended.
...
- `li_sim_scientific_version` → 7 (WP-SCI-03 CFD/FEA/QM tier-2 dispatch).
