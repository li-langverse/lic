...
| [HTTPd Phase H exit graph](../ecosystem/httpd-phase-h-exit-graph.md) | **PH-H** M1 `.li` blocked-by (**PH-2e/2f** → **G-vc**/**G-lean** → P0) — [lic#30](https://github.com/li-langverse/lic/issues/30) |
