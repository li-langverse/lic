...
| Master plan (human-only actions) | [master plan](../superpowers/plans/2026-05-14-li-master-plan.md) |
| CVE catalogs & fuzz | [security testing](../testing/security.md) |
| Package layout | [creating-packages.md](../guide/creating-packages.md) |
...
4. **CVE-relevant tests** must run for every security-touching PR ([security testing](../testing/security.md)).
...
| Policy | Detail |
|--------|--------|
| Prefer **monorepo** `packages/` in **`lic`** or **`lis`** until **8a** (`import`) + **8b** (`lip`) stable | See [governance plan](../superpowers/plans/2026-05-16-li-ecosystem-governance.md) |
...
3. Read [master plan](../superpowers/plans/2026-05-14-li-master-plan.md) phase tracker — know current **PH-** gate.
...
9. Org/repo/settings/secrets → post **“Action needed from you”** and **wait** ([master plan](../superpowers/plans/2026-05-14-li-master-plan.md)).
