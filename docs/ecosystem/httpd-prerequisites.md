...
| P0-bytes | `std` bytes, stringview, Reader/Writer | `lic` | **Shipped (2026-05-22)** — [`std/bytes/bytes.li`](https://github.com/li-langverse/lic/blob/main/std/bytes/bytes.li), `bytes_append`/`bytes_byte_at`, Reader/Writer incremental API; gate `check-w0-bytes-io.sh` |
| P0-net | `raises Net`, trusted syscall RFC | `lic` | **Shipped (2026-05-22)** — [trusted-net RFC](../superpowers/specs/2026-05-16-li-trusted-net-rfc.md), [`trusted.lean`](https://github.com/li-langverse/lic/blob/main/docs/semantics/trusted.lean) v1 axioms, `li-tests/net_trusted/`, [`runtime/li_rt_net.c`](https://github.com/li-langverse/lic/blob/main/runtime/li_rt_net.c) |
...
**Coverage:** `std/**` = **100%**; published `li-*` = **≥80%** ([engineering-standards.md](../ecosystem/engineering-standards.md)).
