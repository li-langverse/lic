...
- **WP-SCI-03 CFD/FEA tier-2 kernels** — `sim_scientific_oracle_checksum_cfd`, `sim_scientific_oracle_checksum_fea`, `run_cfd_tier2_registry`, `run_fea_tier2_registry`; PDE registry split (201–204 heat, 205–210 CFD, 211–216 FEA); `vertical_cfd_lid_driven_cavity` / `vertical_fea_linear_elasticity`; extended `run_algo_registry_tier2.li`.
