...
- **WP-SCI-03 QM tier-2 kernel** — `sim_scientific_oracle_checksum_qm_dft`, `run_qm_tier2_registry` (401–432 dispatch via `chem_dft_scf_iteration_scaffold`); `run_algo_registry_tier2.li` verifies algo 418 real SCF energy (not stub 1.001).
