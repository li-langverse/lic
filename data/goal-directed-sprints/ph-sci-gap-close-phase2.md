...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-08):** QM ids 401–432 tier-2 via `sim_scientific_oracle_checksum_qm`; CFD/FEA rows remain stub pending WP-SCI-05/06.
