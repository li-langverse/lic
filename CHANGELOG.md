...
- **G-proof-db (Partial):** proof database schema, seed entries, `scripts/proof-db/proof-db.py` — [2026-05-25-proof-database-foundation.md](docs/release-notes/2026-05-25-proof-database-foundation.md).
