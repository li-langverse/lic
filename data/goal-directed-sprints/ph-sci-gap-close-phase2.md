...
**Last updated:** 2026-06-07 · **main @** latest (Phase 0/1 + echem merged; WP-SCI-03 QM tier-2 landed in PR)  
...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial (2026-06-07):** QM ids 401–432 → `sim_scientific_oracle_checksum_qm` / `run_qm_tier2_registry`; FEA/CFD rows remain for WP-SCI-05/06.
