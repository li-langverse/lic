...
- **WP-SCI-03 Phase 2 — QM tier-2 registry dispatch** — `sim_scientific_oracle_checksum_qm_dft` (chem `chem_dft_scf_iteration_scaffold`), `run_qm_tier2_registry` (401–432); smokes `run_algo_registry_tier2.li` (418 non-stub), `run_algo_registry_qm_tier2.li`.
