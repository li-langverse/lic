...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed** (2026-06-10): QM/CFD/FEA tier-2 Li oracles + phase0 gate.
2. **WP-PLAT-05** — LAMMPS/GROMACS external oracle column (unblocks SCI-03 MD rows). **Partial landed** (2026-06-10): `md_oracle.toml` stub driver + registry rows.
