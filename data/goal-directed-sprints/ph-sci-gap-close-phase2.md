...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **In progress:** CFD 205–211, FEA 212–216, QM 401–432 (418 stub) tier-2 oracles landed; lid-driven cavity + full Gaussian DFT deferred.
