...
**Last updated:** 2026-06-09 · **main @** `51ad0ba44` (Phase 0/1 + echem merged; start from latest `main`)  
...
1. **WP-SCI-03** — `run_algo_registry` real kernels (CFD/FEA/QM rows); extend `run_algo_registry_tier2.li`. **Partial landed** — branch `chore/agent-code_implementer-wp-sci-03-20260609v2`: tier-2 oracles + dispatch for heat 201–204, CFD 205–210, FEA 211–216, QM 401–432; stub remains for drug/bio/am/viz families.
