...
- **WP-SCI-03 Phase 2 CFD/FEA/QM tier-2** — `sim_scientific_oracle_checksum_cfd` (lid shear profile), `sim_scientific_oracle_checksum_fea_bar` (series-bar constant), `sim_scientific_oracle_checksum_qm` (`physics.quantum` kinetic diagonal); `run_cfd_tier2_registry` (205–210), `run_fea_tier2_registry` (211–216), `run_qm_tier2_registry` (401–432); heat split to 201–204; extended `run_algo_registry_tier2.li`.
...
- `run_algo_registry` splits PDE rows: heat 201–204, CFD 205–210, FEA 211–216; QM 401–432 no longer stub `1.001`; `li_sim_scientific_version` → 7.
